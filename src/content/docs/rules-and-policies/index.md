...
description: "These rules and policies are subject to change. Changes will become effective immediately upon successful vote of adoption by the Board of Directors. The D..."
...
These rules and policies are subject to change. Changes will become effective immediately upon successful vote of adoption by the [Board of Directors](/dms-source/board-of-directors/). The DMS Secretary shall maintain the documented version of the official DMS Rules and Bylaws. A summarized version of these rules will be posted in the space, with a link to the full rules.
...
3.  The [Board of Directors](/dms-source/board-of-directors/) may expel anyone who violates the Code of Conduct via resolution from the premises, online systems, or at sponsored events.
4.  [Officers](/dms-source/officers/) of the Corporation may temporarily suspend a member from the Dallas Makerspace premises, online systems, or at sponsored events provided the following conditions are met:
    ...
    3.  The member being suspended, other [Officers](/dms-source/officers/), and the [Board of Directors](/dms-source/board-of-directors/) are informed in writing as soon as possible
    4.  Upon reviewing reasonably complete details of the incident and believing a temporary suspension to be in error, a [Board](/dms-source/board-of-directors/) member may revoke a temporary expulsion; the Board of Directors may also opt to rescind a temporary suspension by resolution
...
7.  Everyone must sign a liability waiver.
8.  Sleeping within DMS is not permitted. Naps are not prohibited, provided the nap is less than 20 minutes in length, and the member is not laying down in a prone position. Sleeping will only be considered a nap while in the upright sitting position.
...
11. No pets allowed in the building.
12. Don't catch fire, set others on fire, or set anything on fire which has not been designated or designed to be on fire.
13. Spray paint is not allowed to be stored or used on DMS property or the adjacent property and parking lots. (Due to Carrollton city ordinance spray booth requirements.)
14. Harmful behavior, harrassment, stalking, theft, hazing, and otherwise being the opposite of excellent is unacceptable.
15. It is the responsibility of each member to help enforce the Code of Conduct. If someone is violating the Code of Conduct politely explain to them why their behavior is not acceptable. Egregious violations should be reported to a Director or the Officers.
...
1.  A Primary Member must be at least 18 years of age
2.  The DMS is not a day care.
3.  Minors 15 and under must be accompanied closely by Parent or Legal Guardian at all times and are not allowed to have keys to the space.
...
1.  Formal complaints against another member must be submitted, in writing, to the Board of Directors or to any member of the Board of Directors.<sup>\[3\]</sup> The complaint must have two parts outlined at minimum, a "Complaint" part and a "Recommended Solution" part.
...
3.  Dallas Makerspace Does Not allow any Commercial automotive work of any kind at the space. (per 2023-07-12 BoD meeting)
...
3.  Anyone observing this behavior should escalate to an officer or director. If there is not one present, a message should be sent to <admin@dallasmakerspace.org> with the date, time, location of the incident, name of the offender, witness names and any other relevant details.
...
All dues are paid in advance and are recurring. Check is accepted **only** for yearly memberships.

Membership rates for Primary and Add-ons, including Legacy Primary rates, will adjust upward yearly based on the inflation rate. This will happen each January 31st and will be based on the published Consumer Price Index-Urban (CPIU) for the previous year, rounded up to the nearest whole dollar. Discounted rates will be recalculated based on the newly adjusted Primary and Add-On rates.



Current Rate Schedule

 Rate Schedule is effective 2/01/2026.
...
<td>$72/mo</td>
<td>Eligible for voting rights after 90 days of continuous membership, see Voting Rights.</td>
</tr>
<tr>
<td>Legacy 2011</td>
<td>$62/mo</td>
<td><p>Legacy Rate 2011, no longer offered for new members. (Originally $50)</p></td>
</tr>
<tr>
<td>Legacy A</td>
<td>$52/mo</td>
<td><p>Legacy Rate A, no longer offered for new members. (Originally $40)</p></td>
</tr>
<tr>
<td>Legacy B</td>
<td>$42/mo</td>
<td><p>Legacy Rate B, no longer offered for new members. (Originally $30)</p></td>
</tr>
<tr>
<td>Student/Senior/Veteran/Disabled</td>
<td>33.33% discount off members’<br />
applicable monthly or yearly rate</td>
<td><p>A student that meets our other primary membership criteria, e.g. age minimums.</p>
<p>Eligible for voting rights after 90 days of continuous membership, see Voting Rights.</p>
<p>If you qualify, please open a support ticket at https://<a href="http://accounts.dallasmakerspace.org">accounts.dallasmakerspace.org</a> to request.</p></td>
</tr>
<tr>
<td>First Responder</td>
<td>33.33% discount off members’<br />
applicable monthly or yearly rate</td>
<td><p>First Responders are defined as those who qualify under the rules for the <a href="https://id.me/">https://id.me</a> website.</p>
<p><a href="https://help.id.me/hc/en-us/articles/202293510-Am-I-eligible-to-verify-as-a-First-Responder-">https://help.id.me/hc/en-us/articles/202293510-Am-I-eligible-to-verify-as-a-First-Responder-</a></p>
<p>Eligible for voting rights after 90 days of continuous membership, see Voting Rights.</p>
If you qualify, please open a support ticket at https://<a href="http://accounts.dallasmakerspace.org">accounts.dallasmakerspace.org</a> to request.</td>
</tr>
<tr>
<td>Senior</td>
<td>33.33% discount off members’<br />
applicable monthly or yearly rate</td>
<td><p>65 years of age or older.</p>
<p>Eligible for voting rights after 90 days of continuous membership, see Voting Rights.</p>
If you qualify, please open a support ticket at https://<a href="http://accounts.dallasmakerspace.org">accounts.dallasmakerspace.org</a> to request.</td>
</tr>
<tr>
...
<td>33.33% discount off members’<br />
applicable monthly or yearly rate</td>
<td><p>A disabled person with a Social Security Benefit Verification Letter showing that status.</p>
<p>Eligible for voting rights after 90 days of continuous membership, see Voting Rights.</p>
If you qualify, please open a support ticket at https://<a href="http://accounts.dallasmakerspace.org">accounts.dallasmakerspace.org</a> to request.</td>
</tr>
<tr>
...
<td>$778/year</td>
<td>This rate is 10% off the monthly rate of $70. Eligible for voting rights after 90 days of continuous membership, see Voting Rights.</td>
</tr>
<tr>
<td><p>Legacy 2011</p></td>
<td><p>$670/year</p></td>
<td><p>Yearly rate associated with Legacy Rate 2011 monthly rate, no longer offered for new members. (Originally $50/month)</p></td>
</tr>
<tr>
<td><p>Legacy A</p></td>
<td><p>$562/year</p></td>
<td><p>Yearly rate associated with Legacy Rate A monthly rate, no longer offered for new members. (Originally $40/month)</p></td>
</tr>
<tr>
<td><p>Legacy B</p></td>
<td><p>$454/year</p></td>
<td><p>Yearly rate associated with Legacy Rate B monthly rate, no longer offered for new members. (Originally $30/month)</p></td>
</tr>
<tr>
<td>Family Membership Add-on</td>
<td>$21/mo</td>
<td>This rate applies to family members (living in the same household) of a member. These members have access to the space but will not be eligible for voting rights.</td>
</tr>
</tbody>
</table>
...
1.  All members start off as Supporting Members, with no voting rights.<sup>\[6\]</sup>
2.  A Supporting Member must have been a member for the immediate past 90 days to request voting rights and become a Regular Member. Exceptions will be considered on a case by case basis jointly by Officers and .
3.  A member's application to change from Supporting Member to Regular Member must be submitted:
    1.  Via email to <accounts@dallasmakerspace.org> from the email address registered on their account,
    2.  Thru other electronic registration approved by the Board of Directors.
    3.  Rights will be effective upon receipt of the e-mail or electronic registration.
4.  Members added via the Family rate will not be allowed voting rights.
5.  After each Board election cycle the voting rights of each member will be reset and will need to be requested for the next election.
...
2.  Scheduled classes/events should uphold our Mission Statement.
...
6.  Guest access to the facility will be limited as required by the class/event.
7.  Terms and conditions for classes/events can be dictated and modified by the Board of Directors.
8.  The education coordinator, directors, officers, honorarium auditors and calendar administrators may at their discretion cancel or modify scheduled classes or events that are not in keeping with the DMS mission, are deemed inappropriate for DMS, are deemed not to be actual classes/events, represent an abuse of the calendar system, or represent abuse of DMS resources.  The Board of Directors can overturn decisions made by honorarium auditors and calendar administrators.

### Outside Events

      1. Outside events are defined as any event that is unaffiliated with DMS and not sponsored by a committee.\
      2. Outside events must use the two rooms in the north lobby unless prior arrangements are made with officers or board of directors. Arrangements must be made prior to the event’s approval.\
      ...
      6. Any arrangements must be made by emailing <admin@dallasmakerspace.org>.\
      7. All events must be posted on the DMS events calendar.\
      8. Outside events must have a member sponsor and that member sponsor must be onsite from beginning to end of event.\
    ...
    10. Outside events must not prop open any badge access door unless prior arrangement is made.
     ...
     11. Outside events shall be scheduled no more than six months in advance

11.a An exception to this limitation made be made by the Board of Directors, or their designee.

### Honorarium Rules

In furtherance of our mission, Dallas Makerspace may pay honorarium to teachers as a “thank you” for teaching.  The rules below govern the honorarium program and may be modified by the Board of Directors at any time.

#### Requirements

1.  All persons wishing to collect honorarium in excess of \$600 per year must provide a W-9 to DMS’ bookkeepers (dm@[jitasa.is](http://jitasa.is)).
2.  All classes are subject to scrutiny especially where subject matter is vague, potentially unrelated to making, or instruction time is less than 90 minutes to ensure quality of material and value to the DMS and members.
3.  Honorarium auditors cannot approve their own classes or events where honorarium has been requested.
4.  For the duration of their term, no Director may accept honorariums directly from the Dallas Makerspace.
...
2.  Honorarium payments will be limited to six (6) per teacher, per month.  This class limit will be periodically reviewed and adjusted by the Board of Directors.

3.  Teachers will have the option to donate the honorariums they are eligible for to the committee of their choice at the time the class is posted on the DMS calendar.

4.  For all honorarium classes 3 attendees are required to receive honorarium.
    1.  Upon request by the Committee Chair, the Board may approve an exception for this class attendance minimum if the 1) class size is limited because of access to tools, 2) focuses on safety in nature, 3) is required for tool access, AND 4) is in high demand. This exception does not require the Chair to fully or even partially implement the exception.

5.  When a honorarium is requested by a teacher, any class fees requested by the teacher can not exceed the cost of materials and supplies. ( [BoD Reference](/dms-source/board-of-directors/meeting-minutes/2024-2025-board-meeting-minutes/2024-07-10-board-meeting-minutes-approved/) )

## Organizational Meetings

1.  Board meetings with open agendas shall be posted on the Dallas Makerspace Events calendar.
2.  The President shall preside over the Board meetings.
3.  If the President is unavailable, the members of the Board of Directors who are present will choose, via consensus, a temporary meeting chair.
4.  If no member of the Board is present or consensus can not be reached, the committee chairpersons present will vote to determine the temporary meeting chair.
5.  The board of directors may not allocate more than 5% of the checking account balance on discretionary spending without a current financial status from the financial committee or treasurer.
...
3.  Duties of the Vice Chair
    ...
    3.  Help Chair with reviewing financial transactions attributed to their committee and working with the Treasurer or Accountant to correct any errors.
    4.  Serve as Interim Chair when:
...
9.  Each committee will need to maintain a page on the Confluence/Source with at least the following information:
...
1.  At least 3 DMS Members are required to form a Special Interest Group
2.  SIGs may be focused on any topic/subject matter as long as the subject matter does not conflict with DMS’ Code of Conduct

### Formal SIGs\

1.  A Formal SIG is a sub-unit of a committee and must have a sponsoring Committee
2.  To be a Formal SIG, the Sponsoring Committee must vote to add it and include the vote in its Committee Meeting Minutes
3.  The Sponsoring Committee will provide budget and/or space as it sees fit.  However, the Sponsoring Committee maintains control of said resources
4.  The Formal SIG will exist as a Formal SIG at the leisure of the Sponsoring Committee

### Informal SIGs

1.  An informal SIG is not sponsored by a Committee
2.  Informal SIGs are not subject to any special rules or privileges outside of those governing DMS Members
3.  To utilize DMS communication tools such as Talk and Discord, the Informal SIG needs to be recognized
4.  To be recognized, the Informal SIG needs to send a simple message to the Secretary (<Secretary@DallasMakerspace.org>) with name of the SIG, the objective of the SIG, and the Members that voted to form the SIG.
5.  Informal SIGs can be terminated at any time by the Board (examples might include, inactivity, bad behavior, etc.)

## Finances

The organization's finances are controlled by the [Financial Policy Manual.](/dms-source/finance/financial-policy-manual/)

## Organizational Roles and Responsibilities

### Treasurer and Financial Group

The duties of the Treasurer and Financial Group are defined in the [Financial Policy Manual, Dallas Makerspace Treasurer's Office](/dms-source/finance/financial-policy-manual/).
...
3.  Personal property stored in the Project Storage Areas must follow the rules and policies created by the COO which may be changed at any time.
...
7.  Personal property left outside of designated storage areas for more than 24 hours without permission from the COO will be considered abandoned and will be dealt with how the COO sees fit. Please ask for permission rather than forgiveness for storing unusual items.
...
1.  Donations of items intended to be used or consumed by the DMS
    ...
    3.  Donations not explicitly accepted by a committee will not be accepted by DMS; if the donor delivers them to DMS without explicit acceptance they will be disposed of as the COO sees fit
2.  Donations of motor vehicles must have written approval of 3 board members

### Member Exchange Shelf

1.  A Member Exchange (Freebie) shelf will be made available for members to give to and take items from at COO discretion; if no shelf is being made available, these rules no longer apply
...
3.  Certain items are not accepted. The COO or its successor regulates the list of unacceptable items. The [complete list](/dms-source/logistics-and-facilities/member-exchange-shelf/) can be found on the Logistics Committee page.
...
5.  The Member Exchange Shelf is maintained by COO, which may implement additional processes in the interest of safety and orderly operation of the Member Exchange Shelf
...
Members are not permitted to store running or non-running vehicles at the Dallas Makerspace. All cars must be removed from the premises after work, and may not be stored overnight without the permission of the COO who may grant an exception for one 24 hour period only. **All** vehicles left more than 48 hours will be towed without notice at the owners expense. No exceptions.
...
Vehicles owned by *<u>Members only</u>* may use makerspace provided power in the DMS Parking Lot as long as they are working at DMS, and no parking rules outlined above are broken.
...
3.  Primary contact is via <admin@dallasmakerspace.org>
4.  The previous [firearms policy](https://dallasmakerspace.org/wiki/File:Dallas_Makerspace_Policy_on_Working_on_Firearms-20180618.pdf) has been replaced as of the 2019-11-17 BoD meeting
...
Honorarium Change: Per BoD minutes 2024-xx-xx Honorarium rules have changed

    Honorarium change per BoD minutes 2024-07-xx
