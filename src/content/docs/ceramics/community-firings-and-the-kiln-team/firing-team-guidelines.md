---
title: "Firing Team Guidelines"
description: "In order to keep the community firings consistency and quality, (and to save on elements and air conditioning as much as possible), all general firings wil..."
sourceUrl: "https://source.dallasmakerspace.org/display/CER/Firing+Team+Guidelines"
lastUpdated: 2024-01-24
---
**In order to keep the community firings consistency and quality, (and to save on elements and air conditioning as much as possible), all general firings will follow these rules.**
...
1.  Use both hands when loading greenware pieces
2.  If piece is cold/wet, do not load.
3.  Include cone pack 03,04, and 05 on a middle shelf
4.  Move all remaining greenware items to the appropriate shelf for next firing
5.  Post picture of the **remaining greenware items** to Kiln Firing Team info – month year
6.  Ensure that the kiln is locked
7.  Select program
8.  Engage the Vent and set up the warning poles
...
1.  Open at 125 degrees
2.  Avoid picking up bisque by handles or rims
3.  Post pictures of **each shelf** on Ceramic Kiln News – month year
4.  Post picture of the **cone pack** on Kiln Firing Team Info – month year
5.  Put cookies and pillars back in is appropriate places
6.  Ensure that the kiln is locked
7.  Turn off the Vent
...
1.  Check bottoms to make sure no glaze remains
2.  Select cookies appropriate to ceramic piece profile
3.  Remember all glazed items \*must\* have cookies under them
4.  Glaze below a 1/4" from the bottom requires a note explaining why it's ok to fire and the kiln team member will make the final determination ok or not
5.  Include cone pack 5,6,7 on a middle shelf
6.  Turn all handles inward when loaded at the perimeter
7.  Move all remaining glazed items to the appropriate shelf for next firing
8.  Post picture of the **remaining glazed items** to Kiln Firing Team info – month year
9.  Ensure that the kiln is locked
10. Select program
11. Engage the Vent and set up the warning poles
...
1.  Open at 125 degrees or lower
2.  Post pictures of **each shelf** on Ceramic Kiln News – month year
3.  Post picture of the **cone pack** on Kiln Firing Team Info – month year
4.  Put cookies and pillars back in is appropriate places
5.  Ensure that the kiln is locked.
6.  Turn off the Vent
