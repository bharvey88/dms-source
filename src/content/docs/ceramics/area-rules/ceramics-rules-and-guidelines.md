---
title: "Ceramics Rules & Guidelines"
description: "The Ceramics area is on the Warehouse side of DMS. Ceramics has sharp tools, many breakable items, and departments nearby with blow torches and heavy equip..."
sourceUrl: "https://source.dallasmakerspace.org/pages/viewpage.action?pageId=163840133"
...
- People **under** **16** years old must be **directly** supervised by their accompanying adult during the visit.
...
- Bats/ware boards must be **labeled with name/initials/mark and date** **when the piece was thrown/created. **
  - Use the label maker to print your in-progress label.
    - Use masking tape and the sharpie provided on the in-progress shelves to label your pieces if the label maker is out of paper.
...
- Pieces can remain **on bats** for a maximum of **one week** before being moved onto ware boards.
  - If you need to change the bag, do not change the label. Reuse the same label originally printed/written if taped
- Pieces on labeled ware boards will be disposed of if the 21 days has expired from the labeled thrown date.
- If your piece is not dry within the 21 days, you should take it home to dry.
  - If your piece is large/odd/some special situation where this isn’t feasible please [send a message on Talk](https://talk.dallasmakerspace.org/) to @Team_Ceramics
...
- If your glaze piece is taking too long to dry and you need to go, use a heat gun to carefully dry the glaze. This **may** cause the glaze to dry with cracks or flake off if done too quickly, so use this carefully.
...
<img src="/dms-source/files/embedded/CER/ceramics-rules-and-guidelines/image-2025-8-2_17-2-37.png" draggable="false" height="150" />
