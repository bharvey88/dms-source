---
title: "Babylock Ellure ESL"
description: "The Babylock Elluré ESL is a full function sewing machine with utility and decorative stitches, as well as computer-controlled embroidery. Native embroider..."
sourceUrl: "https://dallasmakerspace.org/wiki/Babylock_Ellure_ESL"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Babylock_Ellure_ESL\">legacy DMS wiki</a> — content may be outdated."
---
<img src="/dms-source/files/mw/thumb_0_07_Babylock_Ellure_Sewing_Embroidery_Machine.jpg_300px-Babylock_Ellure_Sewing_Embroidery_Machine.jpg" width="300" height="225" /> BabyLock Ellure ESL <img src="/dms-source/files/mw/thumb_e_ed_Babylock_Arm.jpg_300px-Babylock_Arm.jpg" width="300" height="225" /> Babylock_Arm.jpg
...
<img src="/dms-source/files/mw/1_19_DMS3pt5.jpg" width="390" height="121" alt="3.5 inch wide DMS logo" />
...
- Two file types are shown in the download folder. **You need the .PES files for the Babylock.** [Download DMS logos for stitching.](https://drive.google.com/folderview?id=0ByqBRMriMLgedWdqT0lkb1QtZHc&usp=sharing)
...
- The usable space inside the hoop is in "portrait" format. Once your design is downloaded to the transfer card, using PED-Basic as described in the Detailed Usage Instructions, it can be rotated or flipped. However, if your design is 4x6 landscape format, you will be unable to transfer it to the card. If this occurs, use the [Wilcom TrueSizer web software](http://truesizerweb.wilcom.com/) to rotate your design 90 degrees (available free with sign-up). You will have to stitch the design sideways but in this way you will be able to get the design onto the machine.
- We have simple, easy-to-use embroidery digitizing (i.e., programming) software called SewArt64. Here is a [good introductory tutorial](https://www.youtube.com/watch?v=bIy8ilc9k6E&feature=iv&src_vid=W892-7KnfrE&annotation_id=annotation_3955531083) on how to program a design using the SewArt64 software. There are several other tutorials available from the [software manufacturer's site](http://sandscomputing.com/products-shop/sewart-embroidery-digitizer/) (at the very bottom of the page).

<!-- -->

- You can download a [thirty-day free trial of SewArt64](http://sandscomputing.com/products-shop/sewart-embroidery-digitizer/) (Windows only) on the manufacturer's website.
...
- Sulky brand 40 weight Rayon thread is the brand of thread most commonly available to retail consumers. Sulky publishes two thread reference charts; one showing a [picture of the colors](http://www.sulky.com/fullpanel/uploads/files/sulky-colorchart-panels.pdf), and one showing the [RGB values of each thread](http://www.sulky.com/fullpanel/uploads/files/rayonchart-byfamily.pdf) for more precise programming.

### Patches

Embroidering a patch will be easier if you use a “patch blank”.

- There is a simple tutorial on how to stabilize and stitch patches using patch blanks at: <http://www.allstitch.net/content/how-to-embroider-on-blank-patches-1058.cfm>
- Here is an alternate method to use if you have an irregularly shaped patch: <https://www.youtube.com/watch?v=bHdeFWNVqmk>
- If you are making your own patch blank, the process below will minimize the fuzzies that stick through the border stitching. Laser cutting is optimal, but this is a good alternate procedure.
