---
title: "Resin SIG"
description: "The Resin Special Interest group is for DMS members who are interested in using resins in a wide variety of projects. Resin can be used in so many ways-jew..."
sourceUrl: "https://dallasmakerspace.org/wiki/Resin_SIG"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Resin_SIG\">legacy DMS wiki</a> — content may be outdated."
---
The Resin Special Interest group is for DMS members who are interested in using resins in a wide variety of projects. Resin can be used in so many ways-jewelry, woodworking, creative arts, gaming, fabrication, cosplay - just to name a few. Due to this, there are various ways the Resin SIG has potential to crossover into other committee areas. The current leader for the Resin SIG is Laura Gonzalez (talk handle @starreyedgirl).
...
7.  Brian Cook ([@Brian](https://talk.dallasmakerspace.org/u/Brian))
...
\- <https://www.youtube.com/user/jedrek29t/featured>

\- <https://www.youtube.com/user/NVWoodwerks>
...
[https://dallasmakerspace.org/wiki/Resin_SIG/Equipment101](/dms-source/archive/uncategorized/resin-sig-equipment101/)

## Meeting Minutes

1/18/19 [https://dallasmakerspace.org/wiki/Resin_Meeting_Minutes_1/18/19](/dms-source/archive/meetings/resin-meeting-minutes-1-18-19/)

## Supply Lists from Classes

[https://dallasmakerspace.org/wiki/Dichroish_Class](/dms-source/archive/uncategorized/dichroish-class/)
