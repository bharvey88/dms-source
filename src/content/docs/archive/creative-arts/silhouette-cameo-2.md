...
description: "The Silhouette CAMEO 2 is an electronic cutting machine. It uses a small blade to cut paper, cardstock, vinyl, fabric and more up to 12\" wide 24\" long on a..."
sourceUrl: "https://dallasmakerspace.org/wiki/Silhouette_Cameo_2"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Silhouette_Cameo_2\">legacy DMS wiki</a> — content may be outdated."
---
## What is a Silhouette Cameo 2?
...
[Manual](https://www.uscutter.com/static/PDFs/cameo_manual.pdf)

[Silhouette Studio software](https://www.silhouetteamerica.com/software)

## Silhouette Cameo Machine Anatomy & Accessories:

<img src="/dms-source/files/mw/thumb_f_f0_Silhouette_Anatomy.jpg_300px-Silhouette_Anatomy.jpg" width="300" height="199" /> Silhouette Cameo basic anatomy
...
The Silhouette Cameo uses sticky cutting mats to hold the cutting media. The default mat is 12" by 12", however mats are also available in 12" by 24". Additionally, up to 10' lengths of vinyl can be cut directly from the [roll feeder](https://www.silhouetteamerica.com/shop/accessories/ROLL-FEEDER) (not owned by DMS).
...
<img src="/dms-source/files/mw/thumb_3_30_PixScan.jpg_300px-PixScan.jpg" width="300" height="281" /> Cameo PixScan mat

The [PixScan mat](https://www.silhouetteamerica.com/shop/blades-and-mats/CUT-MAT-PIX12-3T) allows you to cut around any printed image or position cut lines in a specific location on your material using a camera or scanner. The PixScan mat uses registration marks, and when you take a picture of the mat and upload it into the Silhouette Studio Software those registration marks tell the software where the printed image is. The Silhouette blade cartridge has a scanner in it which will read the registration marks and then cut the printed image.

### Blades

#### Standard Ratchet Blade

<img src="/dms-source/files/mw/thumb_e_e7_Standard_Ratchet_Blade.jpg_300px-Standard_Ratchet_Blade.jpg" width="300" height="283" /> Standard Ratchet Blade
...
All Silhouette cutter products use the Silhouette Studio software. The software is currently only installed on one no log-in computer for licensing reasons. DMS owns the Business Edition of Silhouette Studio (Ed. 4.1), but all users can download Silhouette Studio Basic for free on Silhouette America's [website](https://www.silhouetteamerica.com/software). A comparison chart that includes the feature differences between Silhouette Studio Basic and upgraded software versions can be found [here](https://www.silhouetteamerica.com/software/silhouette-studio-features-comparison-chart).
...
Silhouette America has a [Youtube channel](https://www.youtube.com/playlist?list=PL6euVBZ4QfhyiAZbAFRyJTCUObBBZVX7x) which includes numerous how to videos and tutorials to explain the features in Silhouette Studio.

## QR code:

<img src="/dms-source/files/mw/thumb_9_92_Qr-code.png_300px-Qr-code.png" width="300" height="300" /> This QR code is a link to this wiki page.This QR code is a link to this wiki page.
