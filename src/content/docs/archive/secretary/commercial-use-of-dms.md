---
title: "Commercial Use Of DMS"
description: "The Dallas Makerspace has no specific Standing Rules regarding commercial use of the Space, (otherwise defined as for personal profit in this document)."
sourceUrl: "https://dallasmakerspace.org/wiki/Commercial_Use_Of_DMS"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Commercial_Use_Of_DMS\">legacy DMS wiki</a> — content may be outdated."
---
> *The few rules established around [commercial use of the Space](/dms-source/archive/dallas-makerspace/rules-and-policies/#Commercial_Use) are sparse, thus the following is the [Secretary's](/dms-source/archive/dallas-makerspace/secretary/) interpretation of acceptable commercial use of DMS.*
...
The IRS has a lengthy document on [Inurement and Private Benefit Issues](https://www.irs.gov/pub/irs-tege/eotopicc90.pdf). This is a lengthy document, however the second page has a summary of the issue:
