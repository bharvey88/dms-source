---
title: "Board of Directors Meeting 20180323"
description: "DMS Wiki is being migrated to source.dallasmakerspace.org Please go see the content on Source."
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20180323"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20180323\">legacy DMS wiki</a> — content may be outdated."
---
...
Link: <https://source.dallasmakerspace.org/display/Board/2018-03-23+Board+Meeting>
...
**Problem**: Currently, members have to email accounts@dallasmakerspace.org in order to enable their own voting rights, this creates a massive timesink for the Infrastructure committee.
...
## Minutes
    ...
    ***CONSENT AGENDA - DISCUSSION***
    ...
    -Call for vote
       ...
       -  In favor Kris - Brian - Robert - David - Alex
    ...
    **NEW BUSINESS**
    ...
    '''Solution''': Change Rule to read, "Regular membership meetings will be held every '''''2nd Friday at 7pm''''', at the Dallas Makerspace's main location. Beginning May 1 2018"
    ...
    * Both the Member Meeting and Board Meeting will now share the same start times.
    ...
    Add the following to Honorarium Rules:

    "9. For the duration of their term and for a period lasting one year after the end of their term, no Director serving on the Board of Directors may accept personal payment for honorarium"
    ...
    -Call for vote
       ...
       -  In favor  Brian Davis, Robert Davidson, Alex Rhodes, David Kessinger
    ...
    Important Minutes- Kris says she has stopped all work for profit and is not planning on continuing any profit making endeavors at DMS.


    Motion to table until we get a more definitive answer on what is considered profit.


    -Call for vote

       -  In favor  Brian Davis, Robert Davidson, David Kessinger Kris Anderson
    ...
    - DISCUSSION:
      ...
      - Speaker1: David explained the topic.

      - Speaker2:

    - Motion:

       - Proposed by  Brian Davis

       - Seconded by David Kessinger

    -Call for vote

       -  In favor - Brian Davis and David Kessinger

       -  Opposed -

       -  Abstain  - Kris Anderson and Robert Davidson and Alex Rhodes

       -  Motion Fail -  Motion fails due to a non majority.
    ...
    '''Solution''': David proposes that DMS pay for the election fees using the general fund up to $1000.
    ...
    -Call for vote
       ...
       -  In favor  - David - Brian - Kris - Robert - Alex
    ...
    April 4th @ 8 PM CDT is meet the candidate

    April 8th @ 12PM CDT Cutoff for SOI for digital ballet and all members voting digitally

    April 8th @ 7PM CDT Online Voting Begins

    April 12th @ 12 PM CDT Online Voting Ends

    April 12th @ 7 PM CDT SOI deadline for In Person voting

    April 12th @ 8 PM- 10 PM CDT In person voting begins.


    Notes on top of bylaw practices for the voting.


    Online voting will be trusted as a third party vendor (Simply Voting) and the results will be published without any PII data.


    Each Candidate can approve up to 1 person to join the voting committee which will tally the votes.


    Physical Ballets will be destroyed
