---
title: "Class FAQs"
description: "PQ1. Where can I find the schedule for classes? A. Classes and events are listed on the Events Calendar. PQ2. Why doesn’t a class appear on the Events Cale..."
sourceUrl: "https://dallasmakerspace.org/wiki/Class_FAQs"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Class_FAQs\">legacy DMS wiki</a> — content may be outdated."
---
------------------------------------------------------------------------

**Class and Classroom FAQs**
...
*A. Classes and events are listed on the [Events Calendar](https://calendar.dallasmakerspace.org/).*\
...
- You can sign in to [this link](https://whoami.dallasmakerspace.org) using your DMS account information and see your AD Group membership.
...
*A. The [Rooms Guide Page](/dms-source/archive/dallas-makerspace/rooms-guide-page/) of the wiki details the size and capacity of the general-usage rooms. You should not use a committee area unless your class is related to that committee. Long classes should check with the committee chair in advance.*
...
- *You can use an external meeting site like [EventBrite](/dms-source/archive/uncategorized/using-eventbrite-for-dms-classes/) to collect "tuition" / fees. Specify in your class description that fees will be collected through the eternal site and post the link.*
...
*A. After you submit a class the <u>only</u> fields you can change are:*
...
IQ8. Do I have to submit an [**IRS form W-9**](https://www.irs.gov/pub/irs-pdf/fw9.pdf)?\
...
*A. You will typically receive an honorarium check via US Mail within two weeks, assuming you have a W-9 on file and you met all the [official honorarium requirements](/dms-source/archive/dallas-makerspace/rules-and-policies/#Honorarium).* Checks are the only payment mechanism we support.\

IQ10. I **didn't get my honorarium**. What happened?\
*A. Confirm that you took attendance (and Saved it) within 24 hours of your class completion. The calendar system does not request the bookkeeper make payment to the instructor or the committee until attendance is marked. If you forgot to do this, submit an [Issues & Requests ticket](https://talk.dallasmakerspace.org/c/issues-requests) on Talk with the details.*
...
*A. You should have rights to do this manually (please contact the committee chair if you can't).* [Here is a video on how to do it](https://www.youtube.com/watch?v=GeIzsMHJWkY)

IQ14. How do I **sponsor** a non-member to teach a class?\
*A. Submit a new event. In the middle of the page there is a box you can check to SPONSOR a non-member instructor. When you select that box, additional boxes will appear. Check the pull-down list of existing instructors (i.e., those who have taught before). If your instructor is not on that list you will have to provide contact information for the instructor.\
The sponsoring member will have to attend the class.\
If the non-member teacher wants honorarium, the sponsor should decline the honorarium and the teacher should submit an expense statement asking for the honorarium. The sponsoring member will have to take attendance on the Calendar to enable that honorarium request.*

## Other Resources

- [DMS Moodle Online Learning Management System](https://learn.dallasmakerspace.org/login/index.php) (online training resources)

These links below are primarily directed at instructors:

- [So You Want to Teach a Class](/dms-source/archive/dallas-makerspace/so-you-want-to-teach-a-class/) - general description about how to get started with the administrivia about teaching a class, getting the honorarium, etc.
- [Optional Class description template](/dms-source/archive/templates/class-description-template/) - optional (calendar) template to make it easier for instructors to generate class descriptions that meet honorarium requirements, and enable participants to understand what they will get from the class
- [Rooms Guide](/dms-source/archive/dallas-makerspace/rooms-guide-page/) - description of the size/capacity/ features of the teaching classrooms (same link from FAQs above)
- AudioVisual / Electronic [presentation equipment](/dms-source/archive/dallas-makerspace/classroom/) in the classrooms
- [Training Development Special Interest Group](/dms-source/archive/interest-groups/training-development-sig/)
