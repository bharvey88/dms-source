...
description: "These are PROPOSED rules and are not currently in effect. Please see the Rules and Policies page for the active rules. Please discuss this proposal using t..."
sourceUrl: "https://dallasmakerspace.org/wiki/Proposed_Rules"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Proposed_Rules\">legacy DMS wiki</a> — content may be outdated."
---
These are **PROPOSED** rules and are not currently in effect. Please see the [Rules and Policies](/dms-source/archive/dallas-makerspace/rules-and-policies/) page for the active rules. Please discuss this proposal using the forum thread: [Proposed Rule Changes](https://talk.dallasmakerspace.org/t/proposed-rule-changes/807/1).

## Rule and Policy Changes

These rules and policies are subject to change. Changes will become effective immediately upon successful vote of adoption by the [Board of Directors](/dms-source/archive/dallas-makerspace/board-of-directors/) or by the membership at a membership meeting. A summarized version of these rules will be posted in the space, with a link to the full rules.

## Code of Conduct

1.  All guests and members must follow the Code of Conduct.
2.  Directors and the [President](/dms-source/archive/dallas-makerspace/officers/) may ban anyone who violates the Code of Conduct from the premises or online systems. Bans may be reversed upon agreement by 2 or more members of the [Board of Directors](/dms-source/archive/dallas-makerspace/board-of-directors/).
3.  Don't merely respect each other; be excellent to each other.
    ...
    - When you break something, own up to it. If you have any doubt about fixing it, ask for help. Don't make someone feel bad for breaking things, help them understand what went wrong.<sup>[\[1\]](#cite_note-1)</sup>
    - Clean, Maintain, Organize, Improve. Always leave the space better than you found it.<sup>[\[2\]](#cite_note-2)</sup>
    - Don't be afraid to ask questions. Answer them kindly; eventually you'll have to ask for help too.
    - Tools/resources must stay on the premises so that other members may use them.<sup>[\[3\]](#cite_note-3)</sup>
4.  Everyone must sign a liability waiver.
5.  Sleeping is not cool, but naps are ok. We are not a hotel.<sup>[\[4\]](#cite_note-4)</sup>
...
10. It is the responsibility of each member to help enforce the Code of Conduct. If someone is violating the Code of Conduct politely explain to them why their behavior is not acceptable. Egregious violations should be reported to a Director or the [President](/dms-source/archive/dallas-makerspace/officers/).
...
1.  Formal complaints against another member must be submitted, in writing, to the Board of Directors or to any member of the Board of Directors.<sup>[\[5\]](#cite_note-5)</sup> The complaint must have two parts outlined at minimum, a "Complaint" part and a "Recommended Solution" part.
...
| Monthly Membership | \$50/mo | Eligible for voting rights after 3 months, see [Voting Rights](/dms-source/archive/dallas-makerspace/rules-and-policies/#Voting_Rights). |
| Starving Hacker | \$35/mo | This rate is for members who qualify under one of these four categories: in school, unemployed, underemployed, or retired. Please see a board member to find out if you qualify. Eligible for voting rights after 3 months, see [Voting Rights](/dms-source/archive/dallas-makerspace/rules-and-policies/#Voting_Rights). |
| Yearly Membership | \$540/year | This rate is 10% off the monthly rate of \$50. Eligible for voting rights after 3 months, see [Voting Rights](/dms-source/archive/dallas-makerspace/rules-and-policies/#Voting_Rights). |
...
3.  A member's application to change from Supporting Member to Regular Member will be approved automatically upon receipt of the application by the Secretary or President.<sup>[\[7\]](#cite_note-7)</sup>
...
3.  Projects (and materials for them) stored in the Project Storage Areas must follow the rules and policies created by the [Operations and Facilities Committee](/dms-source/archive/archive/operations-and-facilities-committee/) which may be changed at any time.
...
6.  Projects stored in committee rooms or other places outside of the designated Project Storage Areas must follow these additional rules:
    ...
    3.  Projects are urged to create a thread on the forums and a page on the wiki under the projects category.<sup>[\[8\]](#cite_note-8)</sup>
7.  Individual storage areas will be available for each member:
    - Each storage area is approximately 10"x16"x24"<sup>[\[9\]](#cite_note-9)</sup>
...
1.  Events must be on the official calendar to be considered scheduled. Adding events to the calendar can be done from our calendar management system.<sup>[\[10\]](#cite_note-10)</sup>
2.  Scheduling of events is done on a first-come basis, as determined by the calendar management system.
3.  Scheduled events should uphold our [Mission Statement](/dms-source/archive/dallas-makerspace/mission-statement/)
...
2.  To be eligible for the Honorarium, Classes must be submitted to the Board of Directors<sup>[\[11\]](#cite_note-11)</sup> for approval and added to the calendar at least 12 days before the class. Classes must be approved by a majority of the Board of Directors to be eligible for payout.
...
5.  A Honorarium can be forfeited and given to a committee.<sup>[\[12\]](#cite_note-12)</sup>
6.  Honorarium payout requests MUST be submitted, by form<sup>[\[13\]](#cite_note-13)</sup>, within 30 days.
...
3.  For purchases over \$200, the request must include a description of how this spending furthers the organization's Tax Exempt purpose (see [Mission Statement](/dms-source/archive/dallas-makerspace/mission-statement/).)
...
1.  Committees must be approved by the [Board of Directors](/dms-source/archive/dallas-makerspace/board-of-directors/).
...
2.  The owner must contact the [Operations and Facilities Committee](/dms-source/archive/archive/operations-and-facilities-committee/) so that they can record the following information:
    1.  Name of owner
...
4.  Loaned items may be returned at any time, by request of the owner or as determined by the [Operations and Facilities Committee](/dms-source/archive/archive/operations-and-facilities-committee/).
5.  DMS is NOT responsible for maintenance of loaned equipment, but may maintain it as determined by the [Operations and Facilities Committee](/dms-source/archive/archive/operations-and-facilities-committee/).
...
3.  <span id="cite_note-3">[↑](#cite_ref-3) Removing tools/resources from the space without authorization from an [Officer](/dms-source/archive/dallas-makerspace/officers/) or member of the [Board of Directors](/dms-source/archive/dallas-makerspace/board-of-directors/) is theft.</span>
4.  <span id="cite_note-4">[↑](#cite_ref-4) Please drive responsibly, if you are too tired to drive use Uber/Lyft or call a cab.</span>
5.  <span id="cite_note-5">[↑](#cite_ref-5) Primary contact is via admin@dallasmakerspace.org</span>
...
7.  <span id="cite_note-7">[↑](#cite_ref-7) See the [Officers](/dms-source/archive/dallas-makerspace/officers/) page for the names of the current Secretary and President of the Dallas Makerspace.</span>
8.  <span id="cite_note-8">[↑](#cite_ref-8) Add `[[Category:Active Projects]]` to your project page to place it in the [Category:Active Projects](/dms-source/archive/active-projects/) category.</span>
9.  <span id="cite_note-9">[↑](#cite_ref-9) We recommend using this [IKEA SAMLA Box](http://www.ikea.com/us/en/catalog/products/20206316/), Article Number: 202.063.16</span>
10. <span id="cite_note-10">[↑](#cite_ref-10) Use the "Add Event" link on the [Events](http://dallasmakerspace.org/calendar/) page.</span>
11. <span id="cite_note-11">[↑](#cite_ref-11) Board of directors e-mail: admin@dallasmakerspace.org</span>
12. <span id="cite_note-12">[↑](#cite_ref-12) In this case, the committee gets \$100 instead of just \$50.</span>
13. <span id="cite_note-13">[↑](#cite_ref-13) [Honorarium reimbursement form](https://docs.google.com/forms/d/1HFoGOFsRz4ep9fJP8-4s-fDpmT0hTNeTybJDzoS_rgA/viewform?entry.1975545944&entry.1085177&entry.3059548&entry.1628433525&entry.1383316125=None&entry.1242007305=Yes)</span>
