---
title: "Classes"
sourceUrl: "https://dallasmakerspace.org/wiki/Classes"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Classes\">legacy DMS wiki</a> — content may be outdated."
---
## Existing Classes
...
- [Intro to bash shell scripting](https://dallasmakerspace.org/wiki/Intro_to_bash_shell_scripting) and [Basic Linux command line](https://dallasmakerspace.org/wiki/Basic_Linux_command_line) (emphasis on Debian/Ubuntu)
- [Javascript Introduction](/dms-source/archive/hackerspace-committee/javascript-introduction/)

### Advanced Programming

- [Building Virtual Worlds](https://dallasmakerspace.org/wiki/Building_Virtual_Worlds)
- [Building a Virtual Server Museum](/dms-source/archive/hackerspace-committee/interactive-computer-museum/)
