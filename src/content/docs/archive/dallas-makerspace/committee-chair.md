...
description: "The Committee chairperson will be responsible for maintaining the list of committee members and providing reports to the status and activities of the commi..."
sourceUrl: "https://dallasmakerspace.org/wiki/Committee_Chair"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Committee_Chair\">legacy DMS wiki</a> — content may be outdated."
---
## What Committee Chair Does
...
Committee rules are copied here from the [Dallas Makerspace Rules](/dms-source/archive/dallas-makerspace/rules-and-policies/#Committees). In the event of a discrepancy, the DMS rules are the governing document.
...
Also located in [Rules and Policies](/dms-source/archive/dallas-makerspace/rules-and-policies/)
...
Board of Directors (BoD) Meetings - Where rules are voted on, request monetary support for equipment or projects, suggest needs or improvements of DMS in general and the selection of committee chairs, procurement agents, and officers of the corporation.
...
Regular Member and BoD meetings follow [Modified SRC3](/dms-source/archive/dallas-makerspace/modified-src3/) format.

## Classes

Committees usually give classes related to their area of interests. They also can fund themselves by classes that qualify for honorarium. Honorarium can be forgone by the hosting member and designated to a committee.

Official honorarium rules are located in [Rules and Policies](/dms-source/archive/dallas-makerspace/rules-and-policies/#Honorarium_Rules)
...
If your committee would like to purchase equipment using its funds, ask a Procurement Agent for further information. A list can be located [here](/dms-source/archive/dallas-makerspace/procurement-agents/)

## Finances

To view your committee’s funds, email finances@dallasmakerspace.org for access to Quickbooks.
...
Current Committee chairpersons and vice-chairs are listed [at this link](/dms-source/archive/dallas-makerspace/current-chairpersons/).
...
- Names must be updated on the [Current Committee Chairs page](/dms-source/archive/dallas-makerspace/current-chairpersons/) - this does not require any special privileges to edit
