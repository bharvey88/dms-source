---
title: "2020 Statement of Intent Justin Walker"
description: "DMS Wiki is being migrated to source.dallasmakerspace.org Please go see the content on Source."
sourceUrl: "https://dallasmakerspace.org/wiki/2020_Statement_of_Intent_Justin_Walker"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/2020_Statement_of_Intent_Justin_Walker\">legacy DMS wiki</a> — content may be outdated."
---
...
Link: <https://source.dallasmakerspace.org/display/Board/2020+Statement+of+Intent+Justin+Walker>

This is to serve as formal notice of my intent to run for the board of directors of Dallas Makerspace. I am **Skyspook** on Talk and across all DMS platforms
...
[The Makers' Alliance](http://alpha.makersalliance.org/) - Cleveland OH - EIN 27-1288107

[Ohio Filing](https://bizimage.ohiosos.gov/api/image/pdf/200927900620) -- [IRS Filings](https://apps.irs.gov/app/eos/displayAll.do?dispatchMethod=displayAllInfo&Id=5634236&ein=271288107&country=US&deductibility=all&dispatchMethod=searchAll&isDescending=false&city=&ein1=27-1288107&postDateFrom=&exemptTypeCode=al&submitName=Search&sortColumn=orgName&totalResults=1&names=&resultsPerPage=25&indexOfFirstRow=0&postDateTo=&state=All+States)
