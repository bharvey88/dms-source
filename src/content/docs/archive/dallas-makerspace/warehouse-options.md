...
sourceUrl: "https://dallasmakerspace.org/wiki/Warehouse_Options"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Warehouse_Options\">legacy DMS wiki</a> — content may be outdated."
---
...
- Buy a ~20 hp rotary phase converter for the compressor and lathe
  ...
  - **Cons**: [Rotary phase converter](http://www.ebay.com/itm/NEW-20-HP-PHASE-CONVERTER-Heavy-duty-/360575344177) will cost \$1000+, and we can't run the compressor and lathe at the same time. Also consider additional wiring cost. Not as efficient as 3 phase power without the converter (but won't be running much anyway). [Chart Explaining Phase Converter Requirements](http://www.northamericaphaseconverters.com/how-to-size-a-rotary-phase-converter/)
