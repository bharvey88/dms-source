---
title: "So You Want to Teach A Class"
description: "If you're just looking for the steps of class creation in the Calendar system - here is a walkthrough at this link. The rest of this article addresses some..."
sourceUrl: "https://dallasmakerspace.org/wiki/So_You_Want_to_Teach_A_Class"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/So_You_Want_to_Teach_A_Class\">legacy DMS wiki</a> — content may be outdated."
---
## So you want to teach a class...

If you're just looking for the steps of class creation in the Calendar system - here is a walkthrough [at this link](/w/images/a/a7/HowtoaddanewClass.pdf). The rest of this article addresses some of the other intricacies of class creation from scratch.

## Ensure Unmet Need

You have checked the [Calendar](https://calendar.dallasmakerspace.org/) for a few months into the future and the course you want to teach does not appear to be offered. You want to teach it, and no one else appears to already be filling that niche.

## What's next?

### Gauging Interest, Ensuring Activity is Appropriate, Equipment/space Available, etc.

- Checking for activity on the [Talk forum](https://talk.dallasmakerspace.org) is always a good idea. You can also see if anyone posts back about interest.
- There is a specific section in the Classrooms category of Talk called [INTEREST CHECK](https://talk.dallasmakerspace.org/c/classrooms/interest-check) to post and see whether people are interested.
...
- Look at the [Learn to Teach page](/dms-source/archive/class-curriculum/learn-to-teach/) to learn about becoming a teacher and preparing for a class.
...
There is an [optional class description template](/dms-source/archive/templates/class-description-template/) that can help you write this description.

### Select a Location

There are several general classrooms available for members to schedule at Dallas Makerspace. See the [Rooms Guide page](/dms-source/archive/dallas-makerspace/rooms-guide-page/) for details about specific classrooms so you can select the one that is most appropriate.
...
- If you want an [honorarium](/dms-source/archive/dallas-makerspace/rules-and-policies/#Honorarium), 144 hours (6 days) advanced notice is required.
...
Follow the directions (carefully!) under "Getting Paid" at the [Teach](https://dallasmakerspace.org/teach/) link. At the time of this writing, basically:
...
6.  Your [IRS Form W-9](https://www.irs.gov/pub/irs-pdf/fw9.pdf) must be on file before you are paid. If you give the instructor portion to a committee, or if you decline the honorarium, you do not need to bother with the W-9.
...
Official rules governing honorariums are in the [Rules & Policies section](/dms-source/archive/dallas-makerspace/rules-and-policies/#Honorarium).

## But how does it all work after that?

If you're just looking for directions/tutorial, check out this [**link**](/w/images/a/a7/HowtoaddanewClass.pdf).\
...
Secondly, you will need a [DMS domain account](/dms-source/archive/systems-and-infrastructure/how-to-enable-your-active-directory-login/) to manage classes. If you do not have one, and/or are not a member of DMS, your sponsoring member will need to manage your classes.

### Fill Out the Submit Event Form

[Here](/w/images/a/a7/HowtoaddanewClass.pdf) is a summary. Detailed instructions are available at this link.\
At the top of the [Events Calendar](https://calendar.dallasmakerspace.org/) page, click "Submit Event."
...
\(b\) After you submit your event you can change basically only descriptive information. You cannot change date, time, or number of attendees. Specific items are listed in the [Class & Classroom FAQs](/dms-source/archive/dallas-makerspace/class-faqs/).
...
Here is a link to [questions frequently asked by instructors and participants](/dms-source/archive/dallas-makerspace/class-faqs/) regarding classes and classrooms.
