---
title: "2020 - Statement of Intent - Jim Hartnett"
description: "DMS Wiki is being migrated to source.dallasmakerspace.org Please go see the content on Source."
sourceUrl: "https://dallasmakerspace.org/wiki/2020_-_Statement_of_Intent_-_Jim_Hartnett"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/2020_-_Statement_of_Intent_-_Jim_Hartnett\">legacy DMS wiki</a> — content may be outdated."
---
...
Link: <https://source.dallasmakerspace.org/display/Board/2020+Statement+of+Intent+-+Jim+Hartnett>

I, Jim Hartnett, am announcing my intent to run for the 2020-2021 board of the Dallas Makerspace.

<img src="/dms-source/files/mw/thumb_f_f1_Candidate_photo.jpg_300px-Candidate_photo.jpg" width="300" height="400" alt="Photo of Jim Hartnett." /> Hair has grown out a bit, and depending on the month I'll shave. With COVID not around anyone for a good photo anyway. When I'm not running machinery I can also usually be identified by an alleged purple wolf tail, and will come when howled at.
...
- Talk: hon1nbo
- Email: hon1nbo@dallasmakerspace.org
