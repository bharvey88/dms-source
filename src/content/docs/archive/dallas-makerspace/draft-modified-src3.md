---
title: "Draft Modified SRC3"
description: "SRC3 stands for \"Simplified Rules of Coordinated Consensus through Chaos\". It is designed to be a replacement for Robert's Rules of Order. This procedure i..."
sourceUrl: "https://dallasmakerspace.org/wiki/Draft_Modified_SRC3"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Draft_Modified_SRC3\">legacy DMS wiki</a> — content may be outdated."
---
This is a Draft for the [Modified SRC3](/dms-source/archive/dallas-makerspace/modified-src3/).

SRC3 stands for "Simplified Rules of Coordinated Consensus through Chaos". It is designed to be a replacement for [Robert's Rules of Order](http://en.wikipedia.org/wiki/Roberts_Rules). This procedure is modified version of [HacDC's MIBS SRC3](http://wiki.hacdc.org/index.php/MIBS_Simplified_Rules_of_Coordinated_Consensus_through_Chaos), tailored for the Dallas Makerspace.
