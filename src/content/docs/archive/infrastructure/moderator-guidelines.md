...
description: "The Talk Forum is a critical source of knowledge, communication, discussion and debate inside the Dallas Makerspace. Some portions of Talk are visible to t..."
sourceUrl: "https://dallasmakerspace.org/wiki/Moderator_guidelines"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Moderator_guidelines\">legacy DMS wiki</a> — content may be outdated."
---
...
An abbreviated set of Talk behavioral expectations are [described here](https://talk.dallasmakerspace.org/guidelines).
...
The [DMS Code of Conduct](/dms-source/archive/dallas-makerspace/rules-and-policies/#Code_of_Conduct) stated in the Rules and Policies requires that we “Don't merely respect each other; be excellent to each other.” This is a basic tenet of the DMS philosophy.

Further, the [Anti-Harassment policy](/dms-source/archive/dallas-makerspace/rules-and-policies/#Anti-Harassment_Policy) states “Harassment is prohibited and will not be tolerated”.
...
1.  Defer/Ignore. The moderator acknowledges the existence of the flag, but the moderator is allowing community moderation to take its course. If three flags accumulate the post will be hidden; if fewer than three flags accumulate the post will remain. This is the preferred moderator action except where personal attacks have occurred. There is zero tolerance for personal attacks.
2.  Agree with the flag. Post is immediately hidden.
3.  Disagree with the flag. Post is unhidden.
...
<th>Type</th>
<th>Discipline</th>
<th>Who can invoke</th>
<th>Appeal</th>
</tr>
&#10;<tr>
<td>Any</td>
<td>Imminently threatening to other<br />
member, incl. threats of off-Forum<br />
activity</td>
<td>Escalated immediately<br />
to Board</td>
<td>Any moderator</td>
<td>Board</td>
</tr>
<tr>
<td>Any</td>
<td>Patently illegal</td>
<td>Escalated immediately<br />
to law enforcement</td>
<td>Any moderator</td>
<td>N/A</td>
</tr>
</tbody>
...
<td>Talk block -<br />
60 days</td>
<td>Posted on Talk</td>
<td>At least half of<br />
moderators</td>
<td>Board</td>
</tr>
<tr>
...
<td>Personal<br />
attack</td>
<td>Permanent Talk block<br />
and formal complaint<br />
to Board</td>
<td>* Posted on Talk<br />
* Board agenda/minutes</td>
<td>Majority of<br />
moderators</td>
<td>Board</td>
</tr>
...
<td>Civil<br />
Environment</td>
<td>Interim Talk block<br />
and formal complaint<br />
to Board</td>
<td>Board agenda/minutes</td>
<td>At least half of<br />
moderators</td>
<td>Board</td>
</tr>
