---
title: "Machine Shop Tasks"
description: "On the c0-ax indicater the outide diameter tool chipped off. The small peice that looks like an L bit. The \"curved feeler\""
sourceUrl: "https://dallasmakerspace.org/wiki/Machine_Shop_Tasks"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Machine_Shop_Tasks\">legacy DMS wiki</a> — content may be outdated."
---
About this page:
...
- CNC Lathe (such as [HAAS ST-10](https://www.youtube.com/watch?v=wH-R0ud2Tew))
- English Wheel
- Planishing Hammer
- Sheet Metal Roll
...
- Sheet Metal Shear
- For HAAS VF-2
  - [Rotary Table](http://www.haascnc.com/DOCLIB/Rotary-Fit-Config.pdf?0812) (for HAAS VF2)
  - Enclosure light
  - Memory Upgrade
...
- Create [drawer organizers](http://www.ufpt.com/applications/tool-control-foam-inserts.html) for tools
