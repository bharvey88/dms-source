---
title: "Shapeoko 3XXL"
description: "Please see the safety and instructions on DMS Source."
sourceUrl: "https://dallasmakerspace.org/wiki/Shapeoko_3XXL"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Shapeoko_3XXL\">legacy DMS wiki</a> — content may be outdated."
---
<img src="/dms-source/files/mw/thumb_2_2c_Shapeoko3XXL.jpg_300px-Shapeoko3XXL.jpg" width="300" height="182" alt="Shapeoko 3 XXL CNC Router" />

**Please see the safety and instructions on [DMS Source](https://source.dallasmakerspace.org/display/MACH/Shapeoko3+XXL+Files?preview=%2F65372224%2F65372226%2FShapeoko+3+XXL+Safety+and+Operation.pdf).**
...
**It's a [Shapeoko 3XXL](https://carbide3d.com/shapeoko/) from Carbide 3D.**\
...
\- BitZero [User Guide](https://docs.carbide3d.com/assembly/touch-probe/userguide) (for setting X/Y/Z or a combination thereof)\
- [Bit Setter](https://shop.carbide3d.com/products/bitsetter?variant=39303096893501) was added on 4/5/2023 (for setting tool offsets at tool change). See [this Talk post](https://talk.dallasmakerspace.org/t/upgrade-to-the-shapeoko-3xxl-in-plastics/98297?u=jast) for more info.
...
2\. Only specific materials are authorized. See the [MATERIALS](/dms-source/archive/machine-shop/shapeoko-3xxl/#Materials) section for details.\
...
**It's a [Shapeoko 3XXL](https://carbide3d.com/shapeoko/) from Carbide 3D.**\
DMS Shakypoo Checklist: (comittee drive) (N:)-\>machineshop-\>Training-\>Shapoko 3XXL-\>/Checklist.pdf (Also [linked from Talk](https://talk.dallasmakerspace.org/t/checklist-for-shakeypoo-xxl/83794))

DMS Training Slides: (comittee drive) (N:)-\>machineshop-\>Training-\>Shapoko 3XXL-\>/Shapeoko 3 XXL Slides.pdf\
- [Quick Start Guide](https://docs.carbide3d.com/assembly/shapeoko/)\
- [Carbide Create Software User Guide](https://docs.carbide3d.com/assembly/carbidecreate/video-tutorials)\
- [Carbide Motion User Guide](https://docs.carbide3d.com/assembly/carbidemotion/userguide/)\
- [Carbide 3D User Community Forums](https://community.carbide3d.com)\
- [Carbide 3D downloads](http://carbide3d.com/downloads)\
- [Shapeoko's Wiki Site](https://wiki.shapeoko.com/index.php/Main_Page)\
- [A good site on Shapeoko and general milling/routing practices for this kind of machine](https://shapeokoenthusiasts.gitbook.io/shapeoko-cnc-a-to-z/)\

Back to [Plastics and Composites Interest Group](/dms-source/archive/interest-groups/plastics-and-composites-interest-group/)

## Page QR Code

<img src="/dms-source/files/mw/b_b5_Qrcode.png" width="400" height="400" alt="Qrcode.png" />
