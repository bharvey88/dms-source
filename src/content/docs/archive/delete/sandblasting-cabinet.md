...
sourceUrl: "https://dallasmakerspace.org/wiki/Sandblasting_Cabinet"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Sandblasting_Cabinet\">legacy DMS wiki</a> — content may be outdated."
---
**A request has been made to delete this page.**\
If you feel this is in error, please remove the {{delete}} template.

This device is more correctly called a "media blasting cabinet". DO NOT use SAND in it. Sand does wicked nasty things to lungs. Otherwise, please read on.
...
4.  Step on the peddle and the ~~sand~~media hopefully comes out of the nozzle.
