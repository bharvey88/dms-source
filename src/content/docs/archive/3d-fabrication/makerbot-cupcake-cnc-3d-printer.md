---
title: "Makerbot CupCake CNC 3D Printer"
description: "I forked over the $950.00, plus $50.55 shipping and handling on January 31st. It was for the CupCake CNC Deluxe Kit. I've been restless over the last few w..."
sourceUrl: "https://dallasmakerspace.org/wiki/Makerbot_CupCake_CNC_3D_Printer"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Makerbot_CupCake_CNC_3D_Printer\">legacy DMS wiki</a> — content may be outdated."
---
## Arrival

<img src="/dms-source/files/mw/thumb_0_01_Makerbot-package.JPG_480px-Makerbot-package.JPG" width="480" height="360" /> Package from Makerbot Industries

#### Monday, April 5, 2010

I forked over the \$950.00, plus \$50.55 shipping and handling on January 31st. It was for the [CupCake CNC Deluxe Kit](http://store.makerbot.com/cupcake-cnc-deluxe-kit.html). I've been restless over the last few weeks, and it didn't help my anxious state of mind when everyone kept asking when this thing was coming in. I'd check the [Makerbot](http://en.wikipedia.org/wiki/MakerBot_Industries) website every day for some type of update, but no luck. They told me that it would be shipped at the end of March. Keeping true to their word, the order was shipped on March 31st, but not after I briefly gave up my daily check of the order status last week. When I got home from work today, I was startled to discover that it waiting for me on my porch.\
...
-- Mark Havens 21:18, 5 April 2010 (CDT)
...
-- Mark Havens 14:36 12 September 2010



#### Thursday, February 24, 2011

The Makerbot has been in use for many months now. I just put in an order for the MK6 upgrade and also a new nozzle. There is now a [page](/dms-source/archive/3d-fabrication/makerbot-797/) for just this Makerbot and its operational details.\

-- peter242 11:13, 24 February 2011 (CST)



#### Saturday-Sunday, March 20-21, 2011
...
-- peter242 01:12, 21 March 2011 (CDT)



### Final Update

According to the update noted above by peter242 on February 24, 2011, the original Makerbot CupCake CNC 3D Printer at Dallas Makerspace was upgraded to a [Makerbot 797](/dms-source/archive/3d-fabrication/makerbot-797/). Please check out the wiki page for the Makerbot 797 at this [link](/dms-source/archive/3d-fabrication/makerbot-797/): [Makerbot 797](/dms-source/archive/3d-fabrication/makerbot-797/)

-- Lisa S 22:32, 8 September 2014‎ (CDT)
