---
title: "3D Printers"
description: "Since the creation of the 3d Fabrication Committee, we have strived to get equipment that will increase productivity, and limit users only by their imagina..."
sourceUrl: "https://dallasmakerspace.org/wiki/3D_Printers"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/3D_Printers\">legacy DMS wiki</a> — content may be outdated."
---
Since the creation of the 3d Fabrication Committee, we have strived to get equipment that will increase productivity, and limit users only by their imagination.
...
2.  [PolyPrinter Model 508](/dms-source/archive/tools/polyprinter508/)
3.  [RostockMAX V3](/dms-source/archive/tools/rostockmax/)
4.  [RepRap Mendel90](http://reprap.org/wiki/Mendel90) Dibond Frame (1)
5.  [Form 2 SLA printer](https://formlabs.com/3d-printers/form-2/) (File:Form2 SLA Resin Curing.pdf)
