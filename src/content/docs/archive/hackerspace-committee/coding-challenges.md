...
description: "Inspired by old code golf challenges and the latest TIS-100 game. Plus in part of the work for the upcoming demoscene courses. Interactive Computer Museum ..."
sourceUrl: "https://dallasmakerspace.org/wiki/Coding_Challenges"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Coding_Challenges\">legacy DMS wiki</a> — content may be outdated."
---
Inspired by old code golf challenges and the latest TIS-100 game. Plus in part of the work for the upcoming demoscene courses. [Interactive Computer Museum](/dms-source/archive/hackerspace-committee/interactive-computer-museum/) is presenting a monthly coding challenge.
...
- Please have complete examples and make sure all submissions are fully runnable in some manner under a linux or an appropriate emulation system (ie c code works with gcc, c# with mono, javascript with node, asm is x86, etc..)
...
- Challenge ideas are welcome and should be proposed on [talk](https://talk.dallasmakerspace.org/t/monthly-coding-challenges) before becoming official.

## Resources

- [Code Submissions](http://54.218.92.92/) - *Please paste the link into talk to get credit*.
...
| **Theme** | [Windows XP launched, Amiga DOS and workbench anyone?](http://www.computerhistory.org/tdih/October/25/) |
...
|----|----|
| **Skill level** | *hard* |
| **Theme** | [Atari](http://www.computerhistory.org/tdih/November/29/) |
