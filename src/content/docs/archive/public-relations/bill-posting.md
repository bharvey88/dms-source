---
title: "Bill Posting"
description: "THIS IS A PROPOSED PAGE and is not yet \"APPROVED\" but \"PROPOSED\" to help clarify rules around posting."
sourceUrl: "https://dallasmakerspace.org/wiki/Bill_Posting"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Bill_Posting\">legacy DMS wiki</a> — content may be outdated."
---
THIS IS A PROPOSED PAGE and is not yet "APPROVED" but "PROPOSED" to help clarify rules around posting.

Any posting of bills, bulletins, advertisements, or other items on the walls<sup>[\[1\]](#cite_note-1)</sup> within or without Dallas Makerspace (DMS) falls under the purview of the [Public Relations Committee](/dms-source/archive/public-relations/) with exceptions noted below.

------------------------------------------------------------------------

## Bill Posting

With the [revamp of May, 2017](https://talk.dallasmakerspace.org/t/patch-paint-and-add-french-cleat-rails-added-to-the-hallway/21576) we have made an effort to create a more universal, less destructive method of accommodating ANY postings for DMS events so as to diminish the needs for patching, painting, and otherwise extremely time-consuming maintenance to keep our premises beautiful. With that in mind, here are some guidelines for posting ANYTHING at or about DMS.
...
- Postings not on the bulletin boards (when approved) will use [blue tape](https://www.uline.com/Product/Detail/S-9759/Masking-Tapes-S-9759Q1/Uline-Painters-Masking-Tape-2-x-60-yds?pricode=WB0758&gadtype=pla&id=S-9759Q1&gclid=EAIaIQobChMIwuzmotuG1wIVF1mGCh31hA97EAQYASABEgLWnPD_BwE&gclsrc=aw.ds) except if the posting is allowed to use the french cleat system
...
1.  <span id="cite_note-1">[↑](#cite_ref-1) Walls in this context will include ceilings, rooves, or any other surface on which displays may be hung, projected, posted, or otherwise shown.</span>
