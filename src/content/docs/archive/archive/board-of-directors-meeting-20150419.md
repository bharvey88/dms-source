---
title: "Board of Directors Meeting 20150419"
...
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20150419"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20150419\">legacy DMS wiki</a> — content may be outdated."
---
...
[Board_of_Directors_Meeting_20150322#Minutes](/dms-source/archive/meetings/board-of-directors-meeting-20150322/#Minutes)
...
- [Aerospace Committee](/dms-source/archive/inactive-committees/aerospace-committee/) - (Lisa Selk on behalf of Romeo Espana)
...
- [Automotive Committee](/dms-source/archive/automotive/) - Brandon Green
  - Use of auto funds can be [viewed on this spreadsheet](https://docs.google.com/spreadsheets/d/1D3kElxFI4no-IPfcyL6mK0lhXIbz_xMmKDo_XXlQzsA/edit?usp=sharing)
...
- [Public Relations Committee](/dms-source/archive/public-relations/) - Lisa Selk (on behalf of PR Committee)
...
**Solution:** Add the following rules to the [finances section of the DMS rules and policies](/dms-source/archive/dallas-makerspace/rules-and-policies/#Finances):
...
**Problem:** While the HAAS VF-2 VMC is a valuable tool and serves to drive membership growth, it is limited in the types of parts that it can make. Many parts require a lathe, and while we have a manual lathe, a [Y-axis CNC lathe](http://www.mmsonline.com/articles/why-y-axis-for-turnmill-machines2) allows vastly more complex parts to be made [quickly](https://www.youtube.com/watch?v=wH-R0ud2Tew) and [accurately](https://www.youtube.com/watch?v=Dwg4pESzBdw). In addition, having a Y-axis lathe would serve to further drive membership growth.

**Solution:** Get financing for or start setting aside funds to purchase a [HAAS ST-10Y](http://www.haascnc.com/mt_spec1.asp?id=ST-10Y&webID=YAXIS_LATHE#explore&gsc.tab=0) CNC lathe ([\$120,000](/w/images/2/21/HAAS_ST-10Y_Quote.pdf) new, including misc costs such as rigging, electrical, tooling, etc). Having funds available should a used lathe come up for sale would be ideal: ([This lathe](http://www.ebay.com/itm/Haas-ST-10Y-CNC-Turning-Center-with-Live-Tooling-and-Rhinobar-Feed-/261808703681?pt=LH_DefaultDomain_0&hash=item3cf503c8c1) would be over \$106,000 purchased new, not including the bar feeder.)
...
- 3 sets of these [\[1\]](http://www.amazon.com/Bessey-KRK2450-Fixed-Parallel-Includes/dp/B001HSO6VI) \$196.90 x 3 = \$590.70
- 6 more of the smaller ones [\[2\]](http://www.homedepot.com/p/BESSEY-24-in-K-Body-REVO-Parallel-Clamp-with-Composite-Plastic-Handle-and-3-3-4-in-Throat-Depth-KR3-524/204986215?N=5yc1vZc266Zdep) \$39.67 x 6 = \$238.02
- 5 sets of these [\[3\]](http://www.amazon.com/Bessey-VAS23-Vario-Angle-Strap/dp/B0000224B3/ref=sr_1_sc_3?s=hi&ie=UTF8&qid=1428889892&sr=1-3-spell&keywords=bessy+clmaps) \$28.98 x 5 = \$144.90
- 3 sets of [\[4\]](http://www.rockler.com/extra-strap-clips-for-the-bessey-variable-angle-strap-clamp) \$14.99 x 3 = \$44.97
- 6 sets of these [\[5\]](http://www.rockler.com/4-way-equal-pressure-clamp) \$31.99 x 6 = \$191.94
- 2 of these Miter Vices [\[6\]](http://www.woodcraft.com/product/03W55/professional-miter-vise.aspx) \$66.99 x 2 = \$133.98
...
Purchasing this scanner (along with the PRO software upgrade and MultiDrive for significantly better results) will allow us to offer access to additional quality tools that are relevant to our purpose ([https://dallasmakerspace.org/wiki/3d_Fabrication_Committee#Purpose](/dms-source/archive/3d-fabrication/#Purpose)), allowing members the opportunity to use the 3D scanner to learn (and teach) new skills, and to finish their projects with higher precision than we can currently offer. It will also help enhance our abilities to offer more robust classes in the 3D fabrication process from beginning to end.
...
**Details:** Looking at getting a [4 step ladder such as this one](http://www.amazon.com/Tri-Arc-KDSR104166-Industrial-Warehouse-Perforated/dp/B004SIIAPW), the current blue one is 5 steps. The reduction in one step of height shouldn't impact ability to use top project storage and will make it lighter, smaller, safer, easier to move. The weight actuated castors means it wont be possible for people to misuse it in the same ways as the current one.
...
**Problem:** There is a shortage of stools to use while working at the work tables and auto has not been able to purchase needed tools that would benefit the entire workshop, such as complete wrench sets, digital inspection scope, accurate torque wrench, obd2 scanner, interior trim tools, etc. Can [view auto spending and why auto currently has only \$3 here](https://docs.google.com/spreadsheets/d/1D3kElxFI4no-IPfcyL6mK0lhXIbz_xMmKDo_XXlQzsA/edit?usp=sharing)
...
**Solution:** Dissolve the Operations and Facilities Committee. Split it's roles into the [Logistics Committee](/dms-source/archive/logistics/) and the [Infrastructure Committee](/dms-source/archive/infrastructure/). Appoint \[to be determined\] as chair of the Logistics Committee and Andrew LeCody and chair of the Infrastructure Committee.
