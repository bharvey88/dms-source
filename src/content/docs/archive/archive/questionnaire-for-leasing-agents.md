---
title: "Questionnaire for Leasing Agents"
...
sourceUrl: "https://dallasmakerspace.org/wiki/Questionnaire_for_Leasing_Agents"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Questionnaire_for_Leasing_Agents\">legacy DMS wiki</a> — content may be outdated."
---
...
You can type of the information and email it to the mailing list or put it here on the wiki. There are a few space comparison spreadsheets floating around, but unfortunately they are not easy to access. Until the magical best thing in the world shows up, [here is Ed's lame stop gap.](/dms-source/archive/archive/building-search/#List_of_information_about_spaces)
