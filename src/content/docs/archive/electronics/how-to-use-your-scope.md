---
title: "How to use your scope"
description: "Have you ever wanted to know how to use an Oscilloscope? What about a function generator? You can probably guess what a Counter does, but what is it good f..."
sourceUrl: "https://dallasmakerspace.org/wiki/How_to_use_your_scope"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/How_to_use_your_scope\">legacy DMS wiki</a> — content may be outdated."
---
...
- [The Electronics Calculator Website](http://www.cvs1.uklinux.net/calculators/index.html)
- Scroll down to the bottom for some practical use of Lissajous figures [\[1\]](http://oscilloscope-tutorials.com/oscilloscope/meastech.asp)
- [NJARC Oscilloscope Class aka Scopes for Dopes](http://www.youtube.com/watch?feature=player_embedded&v=8ZKMrzTGxLQ) 2h20m
