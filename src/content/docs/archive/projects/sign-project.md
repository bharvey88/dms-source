---
title: "Sign Project"
description: "This project is to create a \"Rube Goldberg\" type sign that will fit in window of the lounge."
sourceUrl: "https://dallasmakerspace.org/wiki/Sign_Project"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Sign_Project\">legacy DMS wiki</a> — content may be outdated."
---
## Sign Idea \#1
...
[Link To Completed Project Pictures](/dms-source/archive/dallas-makerspace/sign/)

<img src="/dms-source/files/mw/thumb_b_b8_SignIdea.svg_300px-SignIdea.svg.png" width="300" height="122" alt="Paul_Brown_Sign_Idea" />
...
Hopefully it will look like this: [Link](http://img.ehowcdn.com/article-new/ehow/images/a08/08/2v/diy-backlit-signs-800x800.jpg)
