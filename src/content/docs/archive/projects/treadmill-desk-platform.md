---
title: "Treadmill Desk Platform"
description: "Note: I've created a forum thread here for discussion of this project and some of the questions/concerns outlined below."
sourceUrl: "https://dallasmakerspace.org/wiki/Treadmill_Desk_Platform"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Treadmill_Desk_Platform\">legacy DMS wiki</a> — content may be outdated."
---
|     |
|-----|
|     |

**Note:** I've created a forum thread [here](https://dallasmakerspace.org/forums/viewtopic.php?f=2&t=138) for discussion of this project and some of the questions/concerns outlined below.
...
I've mocked up a wooden platform in Google SketchUp (model [attached](/w/images/e/e9/Treadmill_Desk_Chair_Platform.zip), screenshots below for easy reference). A 3/4" thick plywood surface, roughly 42" x 48", will be supported underneath by a frame of 2" x 4" support members, which are elevated by three separate 4" x 6" beam 'legs' on each side of the platform / straddling the treadmill.

<img src="/dms-source/files/mw/thumb_3_35_LJC_Platform_Bottom.png_550px-LJC_Platform_Bottom.png" width="550" height="340" /> Bottom view of platform
...
<img src="/dms-source/files/mw/thumb_7_7e_LJC_Platform_Top.png_550px-LJC_Platform_Top.png" width="550" height="340" /> Top view of platform
...
<img src="/dms-source/files/mw/thumb_d_df_LJC_Platform_Side.png_550px-LJC_Platform_Side.png" width="550" height="340" /> Side view of platform
...
The treadmill desk is a [LifeSpan TR1200-DT](http://www.amazon.com/LifeSpan-TR1200-DT-Treadmill-Desk-Model/dp/B006M2PJV0/ref=sr_1_3?ie=UTF8&qid=1362248882&sr=8-3&keywords=lifespan+treadmill+tr1200) which I am loving so far. Only goes up to 4mph, but that's a great brisk pace for speed walking / lightly jogging while watching videos, and ~3mph is my max for reading comfortably; ~2.5mph is the max for typing. At my company's office we have a couple of the much more expensive [Walkstation](http://www.amazon.com/Details-Walkstation/dp/B002JFT2BW/ref=sr_1_1?ie=UTF8&qid=1362249073&sr=8-1&keywords=walkstation) treadmill desks, and those only go up to 2mph - I sometimes find that frustratingly slow now that I've gotten used to mine :) Of course, those have a motorized work surface that can be adjusted for the varying heights of multiple users - definitely needed for the shared office environment they are in.
