---
title: "Microbial Cellulose Fabric"
description: "The DMS textile group and bio group will work together to create sewable fabric from microbial cellulose, cultured from Gluconacetobacter xylinus (previous..."
sourceUrl: "https://dallasmakerspace.org/wiki/Microbial_Cellulose_Fabric"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Microbial_Cellulose_Fabric\">legacy DMS wiki</a> — content may be outdated."
---
## Introduction

The DMS [textile group](/dms-source/archive/projects/textile-hacking-group/) and [bio group](/dms-source/archive/science/bio-group-working-area/) will work together to create sewable fabric from microbial cellulose, cultured from Gluconacetobacter xylinus (previously known as Acetobacter xylinum), B. subtilis, or other suitable microbe. The resulting fabric would be used to create wearable garments.

## Goals

- Establish test colonies of Gluconacetobacter xylinus
  - Colony 1: attempt to isolate and grow a tea-based strain from [Kombucha SCOBY](http://en.wikipedia.org/wiki/SCOBY) (Symbiotic Culture of Bacteria and Yeast).
...
- **2012 Jan 2** - Identified potential strains of interest. Learned that we can obtain research samples commercially but most come with non-commercial use licensing agreements or other "[intellectual property](http://www.gnu.org/philosophy/not-ipr.html)" type encumberances that would prevent eventual open-sourcing of our research. Looks like we'll need to grow our own starting from natural sources.
...
none\|frame\|m\|First generation incubator\</flickr\>

\<flickr\>6645099811\|none\|frame\|m\|Coconut, apple, and tea cultures\</flickr\>

\<flickr\>6729366457\|none\|frame\|m\|Second generation incubator\</flickr\>

none\|frame\|m\|Mutant strain cultures\</flickr\>

\<flickr\>6924905117\|none\|frame\|m\|Third generation incubator\</flickr\>

\<flickr\>6945447837\|none\|frame\|m\|Pellicle from 2nd generation incubator\</flickr\>

none\|frame\|m\|100x photo of 1st generation pellicle\</flickr\>

## References

1.  <span id="cite_note-1">[↑](#cite_ref-1) [CDC Lab Biosafety Levels](http://www.cdc.gov/biosafety/publications/bmbl5/BMBL5_sect_IV.pdf)</span>
2.  <span id="cite_note-2">[↑](#cite_ref-2) [Gluconacetobacter xylinus biohazard rating](http://bccm.belspo.be/db/lmg_species_details.php?NUM=4560&FIRSTITEM=1&RANGE=100)</span>

## Links

### Use for fabric/clothing

- [photos of Suzanne Lee's work](http://biocouture.posterous.com/)
- [photos of Suzanne Lee's work](http://www.biocouture.co.uk/)
- [Poster supporting use of B. subtilis](http://2008.igem.org/files/poster/Imperial_College.pdf)

### Isolation from Natural Sources

- [From coconuts](http://www.mixph.com/2006/05/how-to-make-nata-de-coco.html)
- [From tea/Kombucha](http://www.foodrenegade.com/how-to-grow-a-kombucha-scoby/)
- [From apples](http://users.chariot.net.au/~dna/kombucha.htm)

### Growth Process

- [Open Wetware growth medium for Acetobacter Xylinum](http://openwetware.org/wiki/Acetobacter_Xylinum_Culture) (note that it assumes cellulose is a waste product to be disposed of)
- [Cellulose production in various growth mediums](http://www.springerlink.com/content/l3487201770r2362/)
- [UT Austin, Brown Lab](http://www.botany.utexas.edu/facstaff/facpages/mbrown/) - this lab is the leader in microbial cellulose research
- [Honeycomb architecture produced by Gluconacetobacter xylinus](http://www.sciencedirect.com/science/article/pii/S0144861706004152)
- [Strain improvement of Gluconacetobacter xylinus Strain 2526 for bacterial cellulose production](http://www.academicjournals.org/AJB/PDF/pdf2010/9Aug/Hungund%20and%20Gupta.pdf) - strain NCIM 2526 mutated using UV light to get a higher production rate
- [Influence of carbon sources on cellulose product](http://www.ncbi.nlm.nih.gov/pubmed/19302295) - strain ATCC 53524
- [Google Books: The Prokaryotes](http://books.google.com/books?id=sTsC65kCJbUC&pg=PA183&lpg=PA183&dq=Gluconacetobacter+xylinus+strain&source=bl&ots=9q51rpvWjf&sig=rS8dZc1bFHndbJ-YjNwX4n1xpwE&hl=en&sa=X&ei=AQ4CT-XDC7LIsQKFz5HHAQ&ved=0CC8Q6AEwAzgK) - section about Gluconacetobacter xylinus
- [Isolation of Cellulose Producing Bacteria from Wastes of Vinegar Fermentation](http://www.iaeng.org/publication/WCECS2009/WCECS2009_pp99-102.pdf)
- [Isolation and identification of the genera Acetobacter and Gluconobacter in coconut toddy](http://www.ajol.info/index.php/ajb/article/viewFile/59210/47512)
- [Culture time and compression moulding idea](http://polycom.pucp.edu.pe/ingles/?bacterialcellulose_ing.html)
- [Characterization of cellulose production by a Gluconacetobacter xylinus strain from Kombucha](http://www.ncbi.nlm.nih.gov/pubmed/18704575)
- [Addition of Lactobacillus mali can triple the growth rate of cellulose in Gluconacetobacter xylinus](http://www.ebah.com.br/content/ABAAAAfm0AA/effective-cellulose-production-by-a-coculture-of-g-xylinus-and-l-mali)

### Strain Info

- [Wikipedia article on microbial cellulose](http://en.wikipedia.org/wiki/Microbial_cellulose)
- [Straininfo.net Gluconacetobacter xylinus strains](http://www.straininfo.net/taxa/2900)
- [Microbe Wiki: Acetobacter xylinum (Gluconacetobacter xylinus)](http://microbewiki.kenyon.edu/index.php/Acetobacter_xylinum)
- [JSCC Catalog: Gluconacetobacter xylinus strains](http://www.nbrc.nite.go.jp/jscc/idb/strains?Ins=&page=1&Sn=Gluconacetobacter+xylinus&Snt=0)
- [ATCC: some strains at \$255 per sample, non-commercial use only, precludes open sourcing](http://www.atcc.org/ATCCAdvancedCatalogSearch/AllCollectionSearch/tabid/454/Default.aspx)

### Properties of Bacterial Cellulose and Production Methods

- [Mechanical Properties of Bacterial Cellulose](http://publications.lib.chalmers.se/records/fulltext/129263.pdf)
- [Microbial Cellulose: Fermentative Production and Applications](http://www.ftb.com.hr/47/47-107.pdf) Properties of various types of BC plus some interesting bio-reactor ideas for continuous production
