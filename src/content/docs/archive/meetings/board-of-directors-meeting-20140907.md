---
title: "Board of Directors Meeting 20140907"
description: "This meeting will be held in Modified SRC3 format."
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20140907"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20140907\">legacy DMS wiki</a> — content may be outdated."
---
...
[Board_of_Directors_Meeting_20140824#Minutes](/dms-source/archive/meetings/board-of-directors-meeting-20140824/#Minutes)
...
**Proposal:** Seeking formal approval of this committee. Wiki page: [https://dallasmakerspace.org/wiki/VECTOR_Committee](/dms-source/archive/vector/)
...
**Solution:** An MPLC Umbrella License would allow us to legally show films from many studios (<http://www.themplc.co.uk/page/producer-list>) on the premises, so long as certain license requirements are met. The basic requirements of the license are as follows:
...
**Solution:** Buy a used one for \$200 <http://dallas.craigslist.org/dal/tls/4648231928.html> if still available (while not the table to end all tables, it will suffice)
...
**Solution:** Build out the vent for Kiln. About 285 will be required to connect the Orton kiln vent to the 18in vent hole above the air pump room. For information on kiln vent information see <http://www.paragonweb.com/Kiln_Pointer.cfm?PID=99> . List of Items need(broken down as follows: Y pipe from Standard Supply, 3 90angle, 2 25ft pipe, misc parts & maybe a lift if can't reach the hole.
