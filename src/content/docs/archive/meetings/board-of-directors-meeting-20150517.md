---
title: "Board of Directors Meeting 20150517"
description: "This meeting will be held in Modified SRC3 format."
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20150517"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20150517\">legacy DMS wiki</a> — content may be outdated."
---
...
[Board_of_Directors_Meeting_20150419#Minutes](/dms-source/archive/archive/board-of-directors-meeting-20150419/#Minutes)

## Officer/Committee reports

- [3d Fabrication Committee](/dms-source/archive/3d-fabrication/) - Lisa Selk
  - The current 3D Fabrication Committee's monthly report can be viewed at the following link: [3D Fab Committee Report for May 2015](https://talk.dallasmakerspace.org/t/3d-fab-committee-report-for-may-2015/3052?u=lisaselk%7C)
  - **NEW 3D Fab Support options include:**
    - An e-mail address set up to report any break/fix issues for 3D Fab equipment. The e-mail address is: **3DFab-Support@DallasMakerspace.org**.
...
- [Amateur Radio Committee](/dms-source/archive/inactive-committees/amateur-radio-committee/) - Justin Edwards
- [Aerospace Committee](/dms-source/archive/inactive-committees/aerospace-committee/) - Romeo Espana & Nick McCarthy
...
- [Bio Committee](https://dallasmakerspace.org/wiki/Bio_Committee) - David Ratcliff
...
- [Creative Arts Committee](/dms-source/archive/creative-arts/) - Haley Moore & Nicole Franczvai
...
- [Digital Media](https://dallasmakerspace.org/wiki/AV_Committee) - Natasha Cooks
...
- [Financial Committee](https://dallasmakerspace.org/wiki/Financial_Committee) - Ben Groves
...
- [Infrastructure Committee](/dms-source/archive/infrastructure/) - Andrew LeCody
...
- [Laser Committee](/dms-source/archive/laser/) - William Petefish
  ...
  - NEW Laser Support option: An e-mail address set up to report any break/fix issues for Laser Committee equipment. The e-mail address is: **Laser-Support@DallasMakerspace.org**
- [Logistics Committee](/dms-source/archive/logistics/) - Allen Wan
- [Machine Shop Committee](/dms-source/archive/machine-shop/) - Bryan Gangwere
- [Metal Shop Committee](/dms-source/archive/metal-shop/) - Danny Meeks
- [Public Relations Committee](/dms-source/archive/public-relations/) - Krissy Heishman
- [Wood Shop Committee](/dms-source/archive/wood-shop/) - Dan Henderson
- [VECTOR Committee](/dms-source/archive/vector/) - Nicholas Schell
...
**Problem:**\
As one of the largest and most successful Makerspaces, we really need a reliable way to scan objects with a good quality output. Acquiring a high definition scanner that gives us a good resolution, at a price Dallas Makerspace can afford, will help us continue with our [mission](/dms-source/archive/dallas-makerspace/mission-statement/).

**Solution:**\
To continue improving quality tools and resources that we make available to our membership and community, we are requesting funds to acquire a NextEngine 3D Scanner HD scanner (along with the PRO software upgrade and MultiDrive for significantly better results) which will allow us to offer access to additional quality tools that are relevant to our purpose ([https://dallasmakerspace.org/wiki/3d_Fabrication_Committee#Purpose](/dms-source/archive/3d-fabrication/#Purpose)). Andrew Falgout has already donated money toward it, so the 3D Fabrication Committee has \$446.75 in funds that we can contribute to the final cost.
...
**Solution:** Dispose of current fans and allocate \$450 to Logistics for purchase of 3 portable [24 inch drum fans](http://www.northerntool.com/shop/tools/product_200038824_200038824)
...
**Solution:** Allocate \$1500 to Logistics for purchase of [a 20 ft^3+ glass door merchandiser refrigerator](http://www.centralrestaurant.com/23-Cu-Ft-Swing-Glass-Door-Merchandiser---Refrigerator-1-Door-27-inW-c182p47914.html)
...
**Solution:** Setup the SawStop as the primary saw used in the woodshop, allocate up to \$6,300 to Woodshop for purchase [\[1\]](http://www.sawstop.com/table-saws/by-model/industrial-cabinet-saw#build-price/industrial-cabinet-saw_ICS73230_52_TSA-ODC_SBC_SZC_TSI-DLD) (AR) I added more for the mobile base, extra regular cartridges, blades, Inserts for dados and cartridges for dados.
...
**Problem:** The cost of replacing damaged and work tooling and consumables is taking a considerable amount of the machine shop budget. [(Current Expenditures)](/w/images/8/8b/Machine_Shop_Replacement_Tooling_Costs.pdf) A better use for this money would be expanding the capabilities of the machine shop (acquiring new equipment).\
...
**Solution:** Purchase a new SuperMicro server that cost's (\$8,049.89) that will give us the CPU power to handle an increased load on the jump environment [\[2\]](http://secure.newegg.com/WishList/PublicWishDetail.aspx?WishListNumber=27302665)
...
**Solution:** Purchase the upgraded plan for \$918 per year an increase from the \$459 price point we are currently at. [\[3\]](https://www.smartwaiver.com/m/chargify_parent/sw_chargify_main.php?sw_chargemain_change_plan&rand=555644984b49b)
