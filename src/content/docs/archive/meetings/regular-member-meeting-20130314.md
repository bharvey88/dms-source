---
title: "Regular Member Meeting 20130314"
description: "This meeting will be held in MIBS SRC3 format."
sourceUrl: "https://dallasmakerspace.org/wiki/Regular_Member_Meeting_20130314"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Regular_Member_Meeting_20130314\">legacy DMS wiki</a> — content may be outdated."
---
...
[Prior minutes](/dms-source/archive/meetings/regular-member-meeting-20130207/)
...
The [Storage](/dms-source/archive/dallas-makerspace/rules-and-policies/#Storage) section should be renamed "Storage / Lost and Found" and read:
...
6.  Projects can be stored in committee controlled rooms, as long as they follow the committee's guidelines and have filled out the "[DMS Project Request Form](/w/images/0/0b/DMS_Project_Request_Form.rtf)" and filed it with a member of the [Board of Directors](/dms-source/archive/dallas-makerspace/board-of-directors/).
...
Rule \#1 of the [Donations](/dms-source/archive/dallas-makerspace/rules-and-policies/#Donations) section should be reworded to read:

1.  Donations of usable items MUST be approved by a [member of the board](/dms-source/archive/dallas-makerspace/board-of-directors/) or the [comittee](/dms-source/archive/committees/) in charge of the location in which the item will be stored/used.

#### Modification of Standing Rules on Code of Conduct (Andrew LeCody)

The [Code of Conduct](/dms-source/archive/dallas-makerspace/rules-and-policies/#Code_of_Conduct) section should be rewritten to read:
...
5.  Don't remove tools or supplies from the space without permission from the [Cribkeeper](/dms-source/archive/dallas-makerspace/cribkeeper/).
...
<span class="small">**Note: draft version of meeting minutes go to the Talk Page first, upon ratifying at the \*next\* meeting they will be moved to the normal page.**</span>
