---
title: "Steering Committee Meeting 20110308"
description: "Previous minutes Steering_Committee_Meeting_20110222"
sourceUrl: "https://dallasmakerspace.org/wiki/Steering_Committee_Meeting_20110308"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Steering_Committee_Meeting_20110308\">legacy DMS wiki</a> — content may be outdated."
---
- To be held in [MIBS SRC3](http://wiki.hacdc.org/index.php/MIBS_Simplified_Rules_of_Coordinated_Consensus_through_Chaos) format
...
Previous minutes [Steering_Committee_Meeting_20110222](/dms-source/archive/meetings/steering-committee-meeting-20110222/)
...
- Status of review of by-laws
  ...
  - **Still some stuff remaining on the ByLaws, here: [Proposed_Bylaws](/dms-source/archive/dallas-makerspace/bylaws/)**
...
- Building sub-committee (physical space ToDo list--Alyssa Pipe, Physical space sub-committee)
  ...
  - Need listing of capital expenditures ([Current Needs](/dms-source/archive/dallas-makerspace/current-needs/) and Space_Checklist)--Need lists of WHAT, COST, and PRIORITY
    - Results of Forum Poll for in-space items.

## Agenda

- Payment of \$378.86 to Alyssa Pipe for purchase of router
  - Problem: Alyssa would like to get re-imbursed for the purchase of the router for the CNC table. The [receipt](https://dallasmakerspace.org/admin/w/images/e/ea/Router_receipt.20110227.pdf) is on the admin wiki.
...
- Seriously consider rules for meetings, check out HacDC's rules, [MIBS SRC3](http://wiki.hacdc.org/index.php/MIBS_Simplified_Rules_of_Coordinated_Consensus_through_Chaos)
