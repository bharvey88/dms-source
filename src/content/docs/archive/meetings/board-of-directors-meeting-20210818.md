---
title: "Board of Directors Meeting 20210818"
description: "Member recognition (above and beyond) and member complaints will be considered before other business. This will allow members that are interested or involv..."
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20210818"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20210818\">legacy DMS wiki</a> — content may be outdated."
---
## Time, location

- **Time & Place:** 2021-08-18 19:00, Dallas Makerspace
- **Google Meet .info**
  - **ID:** <https://meet.google.com/sca-gyqb-wme>
...
## Minutes
    ...
    https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20210807_Special_Meeting
    https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20210810_Special_Meeting
    https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20210811_Special_Meeting
    ...
    MEMEBER RECOGNITION
       ...
       - BoD recognizes and thanks Tim Bene
       - BoD recognizes and thanks Randy Lisbona

    ====
    NEW BUSINESS

    NB 7.1
    - AS WRITTEN: "Allow Machine Shop to purchase perpetual licenses for MasterCam as per the committee voted on 7-24-21. The cost of the licenses are 300$ per fixed license & 320$ per floating license. These licenses are EDU version, we do have documentation from the MasterCam vendor that we qualify for this. We want to purchase 5 floating licenses & 1 fixed license to stay on the computer with the HAAS. This will allow for there to be a more permanent class structure, specifically for HAAS. This will allow us to become CAD independent, specifically for the HAAS training. MasterCam should be able to do other g-code generation as well for our other CNC machines."
    - Motion: Approve up to 7 floating licenses & 1 fixed.
      - Proposed Justin
      - Seconded James
    - Vote
      - For UNANIMOUS
