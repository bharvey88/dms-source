---
title: "Board of Directors Meeting 20160216"
description: "This meeting will be held in Modified SRC3 format."
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20160216"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20160216\">legacy DMS wiki</a> — content may be outdated."
---
...
[Board_of_Directors_Meeting_20160119#Minutes](/dms-source/archive/meetings/board-of-directors-meeting-20160119/#Minutes)
...
Purchase five (5) tanks disguised as sewing machines AKA beasts of sewing machines that can take abuse, are unified for ease of instruction, sharing special accessories, class usage and maintenance. After LOTS and LOTS and LOTS of research we've finally settled on the [Janome S-7330](http://janome.com/en/machines/sewing/schoolmate-s-7330-1) (total cost \$1750) a machine typically bought for high school settings. I've also pitted several sewing machine distributors against each other and driven the price down to \$350 - this is as good as I could do MSRP \$649. I've passed up the idea of sponsorship - due to time constraints and maintaining my own sanity. \*DMS members will need to take a sewing class OR pass a simple sewing quiz (online) to gain access to the code to use the sewing machines. We are going to put a [numerical lock](http://www.walmart.com/ip/4-TSA-Approved-Combo-Luggage-Travel-Sentry-Locks-Red-Indicator-Open-Alert-Pop-Up-PINK/49271673) on the plug-in to make sure we don't experience abuse something like this (total cost \$40) yes -pink. I would like to also see if you are willing to purchase a [storage cabinet](http://www.samsclub.com/sams/tall-storage-cabinet-stainless-doors/prod14570055.ip?navAction=) so we can keep them stored low (\$209- Sam's) Whew, I talk a bunch.
...
[vacuum chamber](http://www.amazon.com/gp/product/B00E0BG8R4?colid=Y6DKH%20vacuum%20chamber%5D) digital gram scale [pressure chamber](http://www.amazon.com/California-Air-Tools-365B-5-%20pressure%20chamber) Val has been working hard to build a variety of mold making classes for makerspace. Buying additional tools for mold making will This will allow increase the ability for members to use different machines for advanced mold making.
...
[8 in 1 heat press](http://www.amazon.com/Iglobalbuy-T-shirt-Digital-Transfer-Sublimation/dp/B00O3EL1HK/ref=cm_cr_pr_product_sims?ie=UTF8%20heat%20press%20system) [dye sublimation printer](http://www.uscutter.com/Sawgrass-Virtuoso-SG400-Dye-Sublimation-Printer%20printer) This is can be used for framing, paper arts, t-shirts, hats, mugs, and all sorts of other items. Cary Fleming is going to allow CA borrow his machine for two months and he will teach a total of four classes to help us start the ball rolling on interest. I see people easily using this machine (at a cost) to make promotional items and turning a profit. Creative Arts will not be providing the blank hats, mugs, plates, shirts, and mousepads for users - simply telling the users where to purchase them. We will be providing the transfer paper at a cost (approx \$2 but I need to do more research)

- Building on existing program - Fiber Arts: (\$700 total)

[Wool Combs](https://www.etsy.com/listing/217618543/wool-combs-extra-fine-valkyrie-viking) \$160 [Comb holding pad](https://www.etsy.com/listing/217679880/combing-pad-for-valkyrie-combs) \$20 [drum carder](http://www.fancy-kitty.com/store/p46/Kitten_Drum_Carder--Manual.html) \$440 brush attachments \$45 small additional tools to aid the processes (--hand-held packing brush (\$5-15ish) doffing pick (long cheap screwdriver) \$30
...
[2 rolling storage cabinets](http://www.samsclub.com/sams/tall-storage-cabinet-stainless-doors/prod14570055.ip?navAction=) \$418 [2 workbenches](http://www.samsclub.com/sams/ultra-heavy-duty-workbench/prod1490086.ip?navAction=push) \$418 [2 rolling cabinets](http://www.samsclub.com/sams/4-drawer-cabinet-hard-wood-top/prod13760146.ip?navAction=push) \$418 [2 Malm Desks with pull-out panel](http://www.ikea.com/us/en/catalog/products/60214183/#/70214192) \$300 [1 Mike desk](http://www.ikea.com/us/en/catalog/products/10244743/#/80213074) \$80 Assorted items for organization of vinyl (pegboard, eye hooks, dowel rods) \$100
...
First incident:\
<img src="/dms-source/files/mw/thumb_4_4d_Pingpong1.png_500px-Pingpong1.png" width="500" height="242" alt="Pingpong1.png" />\
<img src="/dms-source/files/mw/thumb_5_56_9a1838b92854d4cafc054acb2934dc38758df5ce.png_500px-9a1838b92854d4cafc054acb2934dc38758df5ce.png" width="500" height="282" alt="9a1838b92854d4cafc054acb2934dc38758df5ce.png" />\

Apparently Jason and Gus intentionally made and left a mess on the ping pong table in a mistaken attempt to 'make a point'.

Second incident:\
<img src="/dms-source/files/mw/thumb_8_8f_Brandonoffence.png_500px-Brandonoffence.png" width="500" height="263" alt="Brandonoffence.png" />\
...
**Solution:** Invest up to \$5,600 to purchase at least 32 new office / task chairs to replace existing chairs which would be thrown away, potentially the [Costco ProLine II Delux Adjustable Air Grid Ergonomic Office Chair](http://www.costco.com/Pro-Line%E2%84%A2-II-Deluxe-Adjustable-Air-Grid-Back-16-pk-Ergonomic-Office-Chair.product.11762411.html) (\$162 each in packs of 16). Allocate money to Logistics committee and the exact chair model to order would be up to logistics chair.
...
<img src="/dms-source/files/mw/thumb_3_39_ELabCameraView.jpg_600px-ELabCameraView.jpg" width="600" height="341" /> Camera View in Electronics Room
...
<img src="/dms-source/files/mw/thumb_e_e6_NIVirtualBench.png_300px-NIVirtualBench.png" width="300" height="200" /> NI Virtual Bench
...
## Minutes
    ...
    *** Pulled Consent Agenda Items ***
    ...
    - Add two email aliases recipts@dallasmakerspace.org, honorarium@dallasmakerspace.org for handling of financial related emails
