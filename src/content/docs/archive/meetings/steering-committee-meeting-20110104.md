---
title: "Steering Committee Meeting 20110104"
description: "(I jotted this down during the meeting) 501c3 is a Charitable organization. Andrew made an events calendar on Google Apps Nicole, re: PR Andrew, created th..."
sourceUrl: "https://dallasmakerspace.org/wiki/Steering_Committee_Meeting_20110104"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Steering_Committee_Meeting_20110104\">legacy DMS wiki</a> — content may be outdated."
---
## Meeting Agenda
...
- Sub Committees
  ...
  - Building sub-committee (physical space ToDo list--Eric Chaney)
    ...
    - Need listing of capitals expenditures ([Current Needs](/dms-source/archive/dallas-makerspace/current-needs/) and Space_Checklist)--Need lists of WHAT, COST, and PRIORITY
...
(I jotted this down during the meeting) 501c3 is a Charitable organization. Andrew made an events calendar on Google Apps Nicole, re: PR Andrew, created the forums, at dallasmakerspace.org/forums/ We discussed starting some basic forums, Projects, Events, Start with just General and go from there. Perhaps an administrative (to the forums) area first as well. Take FAQs, suggestions, etc in there. Accounting Status of dallasmakerspace.com Email addresses; settled on "treasurer\<at\>dallasmakerspace.org"--have it forward to users (no need for GMail account). Also need dms\<at\> and dmsbiz\<at\> accounts to replace the \<at\>dprg.org ones. Andrew also to get into contact with Ed re: dallasmakerspace.com
