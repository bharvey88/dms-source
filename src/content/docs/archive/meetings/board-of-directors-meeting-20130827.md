---
title: "Board of Directors Meeting 20130827"
description: "This meeting will be held in Modified SRC3 format."
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20130827"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20130827\">legacy DMS wiki</a> — content may be outdated."
---
...
[Board_of_Directors_Meeting_20130721#Minutes](/dms-source/archive/meetings/board-of-directors-meeting-20130721/#Minutes)
...
- [Photography Lab](/dms-source/archive/photography/photography-lab/) (Darkroom Committee) - Nicole LeCody
  - Darkroom Committee is working on changing its name to the Photography Committee. I believe this will help make it clear what we are about as well as make it clear we cover digital as well as film.
  - An emailing list has been created for the committee and I have begun compiling a list of people who wish to be added to it.
  - We had an event at the space that drew in a lot of interest. Steve Rainwater taught a 'How to Photograph Models" class and we had some lovely models come out and pose for us around the space. I would like to plan more of these classes as well. Currently in the planning stages:
    - Working with Strobes
    - Working with Green Screens
    - Intermediate Photoshop
    - Advanced Photo Touch Up
    - Develop Your Own Film
    - Develop Your Own Prints
  - And several ideas for photo walks that will be held on weekend days instead of the regular Foto Friday.
  - As if right now nothing concrete is planned but Foto Friday's continue on their regular schedule or alternating Fridays.
...
Authorize the creation of the [Foundry Committee](/dms-source/archive/ceramics/) with John Kuhlenschmidt as the committee Chair.
...
**Solution:** Add the following to the [Donations section of our standing rules](/dms-source/archive/dallas-makerspace/rules-and-policies/#Donations):
...
**Solution:** Purchase 3x [Cooler Master Hyper 212 Plus](http://amzn.com/B002G1YPH0) for \$30/each, \$90 total.
