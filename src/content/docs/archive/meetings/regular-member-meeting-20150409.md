---
title: "Regular Member Meeting 20150409"
description: "This meeting will be held in MIBS SRC3 format."
sourceUrl: "https://dallasmakerspace.org/wiki/Regular_Member_Meeting_20150409"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Regular_Member_Meeting_20150409\">legacy DMS wiki</a> — content may be outdated."
---
...
[Prior minutes](/dms-source/archive/meetings/regular-member-meeting-20150212/)
...
- [Automotive Committee](/dms-source/archive/automotive/) - Brandon Green
  ...
  - We will be taking the DMS Racing 240sx to [NTAXS event \#2](http://www.ntaxs.com/), anyone else who would like to autox is encouraged to register now so they can attend
- [Bio Committee](https://dallasmakerspace.org/wiki/Bio_Committee) - David Ratcliff (interim)
...
- [Civic Hacking](https://dallasmakerspace.org/wiki/Civic_Hacking) - Stephen Wylie
  ...
  - There are several projects in flight. If you are interested in helping with these projects, come out to the Maptime event next week or hit up Stephen on the Talk page!
    ...
    - ["N Minutes From the Makerspace"](https://dallasmakerspace.org/wiki/Civic_Hacking#N_Minutes_From_the_Makerspace) -- where we map out interesting places to go that are N minutes (e.g. {5, 10}) away
    - ["Makers Markers"](https://talk.dallasmakerspace.org/t/what-local-makery-stores-cant-you-live-without/), a crowdsourced & indexed map of supply and project stores around DMS that people could use to buy materials near DMS or near home
...
- [Laser Committee](/dms-source/archive/laser/) - William Petefish
  ...
  - We now have a support e-mail. (Laser-Support@dallasmakerspace.org)
