---
title: "Board of Directors Meeting 20190523 Special Meeting"
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20190523_Special_Meeting"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20190523_Special_Meeting\">legacy DMS wiki</a> — content may be outdated."
---
PURPOSE: Discuss immediate need & emergency business items
    ...
    ====
    MOTION: Accept Treasurer role description as currently exists (and lock it down):
    "
    ...
    * Supervise and coordinate an audit.
    ...
    ====
    - MOTION: Treasurer “applications” deadline to be Monday, May 27 at 10pm.
      - PROPOSED BY: James
      - SECONDED BY: Ken
    - VOTE
      - In Favor: Unanimous
    ...
    ====
    - MOTION: Appoint David Ratcliff as phase 2 expansion manager.
      - PROPOSED BY: James
      - SECONDED BY: Julie
    - VOTE
      - In Favor: Unanimous
    ...
    ====
    - MOTION: Give Rich Meyer a $5,000 limit for authorizing contracts and approving supply purchases for expansion within the existing approved expansion budget.
      - PROPOSED BY: Julie
      - SECONDED BY: Scott
    - VOTE
      - In Favor: Unanimous
