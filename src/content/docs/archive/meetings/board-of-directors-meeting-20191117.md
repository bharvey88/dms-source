---
title: "Board of Directors Meeting 20191117"
description: "It is now <48 hours until the meeting, thus the agenda has been locked down. Negotiate with the Secretary if you'd like to add or update an agenda item."
sourceUrl: "https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20191117"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20191117\">legacy DMS wiki</a> — content may be outdated."
---
*It is now \<48 hours until the meeting, thus the agenda has been locked down. Negotiate with the [Secretary](/dms-source/archive/dallas-makerspace/secretary/) if you'd like to add or update an agenda item.*
...
[https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20191013#Minutes](/dms-source/archive/meetings/board-of-directors-meeting-20191013/#Minutes) [https://dallasmakerspace.org/wiki/Board_of_Directors_Meeting_20191103_Special_Meeting](/dms-source/archive/meetings/board-of-directors-meeting-20191103-special-meeting/)

## Financial Statement

[2019-11 Financial Statement](https://dallasmakerspace.org/w/images/8/8f/Financial_Statement_2019-11.pdf)
...
**Problem**: The [Firearms Policy](https://dallasmakerspace.org/w/images/e/e1/Dallas_Makerspace_Policy_on_Working_on_Firearms-20180618.pdf) is badly-written, wordy, and repetitive.
...
**Problem**: Adoption of the [Financial Policy Manual](/dms-source/archive/dallas-makerspace/financial-policy-manual/) (aka SOP) has resulted in conflicts between various rules and the SOP.
...
>
> **Standing Rules, [Committee Responsibilities and Rules](/dms-source/archive/dallas-makerspace/rules-and-policies/#Committee_Responsibilities_and_Rules)**
>
> 1.  Purchasing bullets remove
> 2.  Point to SOP Internal Controls, Board-set allocation and authorization limits
>
> **Standing Rules, [Finances](/dms-source/archive/dallas-makerspace/rules-and-policies/#Finances)**
>
> 1.  Remove all present text
> 2.  Point to SOP
>
> **Standing Rules, [Organizational Roles and Responsibilities](/dms-source/archive/dallas-makerspace/rules-and-policies/#Organizational_Roles_and_Responsibilities)**
>
...
*Replace [Committee Leadership](/dms-source/archive/dallas-makerspace/rules-and-policies/#Committee_Leadership) section with the following:*
...
*Insert the following as new Chair Elections section between [Committee Leadership](/dms-source/archive/dallas-makerspace/rules-and-policies/#Committee_Leadership) and [Committee Responsibilities and Rules](/dms-source/archive/dallas-makerspace/rules-and-policies/#Committee_Responsibilities_and_Rules) sections:*
...
*Insert the following in [Committee Responsibilities and Rules](/dms-source/archive/dallas-makerspace/rules-and-policies/#Committee_Responsibilities_and_Rules) after current rule #4:*
...
**Solution** : Authorize the use of DMS General Funds to purchase and ship eight pairs 19"/500mm Wolf Jaw blacksmith tongs from www.blacksmithsdepot.com.  Cost (as of this writing): 8@\$45.00 = \$360.00 + \$26.12 for UPS Ground (cheapest option) = \$386.12.  Request for authorization of up to \$450 in case of a small price change.
...
## Minutes
    ...
    * No old business on the agenda
    ...
    ----
    6.4 Clarify Committee Elections and Chair/Vice Chair-Elect Statuses
    - AS WRITTEN:
    "
    ...
    * Committee meeting minutes must be posted in a timely fashion on the wiki following the conclusion of each meeting and shall adhere to standards established by the Secretary.
    ...
    ----
    6.5 Purchase Tongs for Blacksmithing Classes
    - AS WRITTEN:
    "
    Authorize the use of DMS General Funds to purchase and ship eight pairs 19"/500mm Wolf Jaw blacksmith tongs from www.blacksmithsdepot.com.  Cost (as of this writing): 8@$45.00 = $360.00 + $26.12 for UPS Ground (cheapest option) = $386.12.  Request for authorization of up to $450 in case of a small price change.
    "
    ...
    ----
    MOTION: Pass Consent Agenda items 6.1, 6.2, 6.3, 6.4, 6.5 as written
      - Proposed: James
      - Seconded: Julie
    - VOTE
      - In Favor: UNANIMOUS
    ...
    ====
    NEXT BOARD MEETING 12/15 15:00
      - Proposed: James
      - Seconded: Ken
    - VOTE
      - In Favor: UNANIMOUS
    ...
    ====
    Statement on the expulsion of Stan Simmons by Brad Simms


    ====
    MEETING ADJOURNED 16:02
