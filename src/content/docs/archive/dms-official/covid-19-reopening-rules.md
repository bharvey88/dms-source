---
title: "Covid-19 reopening rules"
description: "The following rules apply for the re-opening period following COVID-19. There is no set end-date for these rules at this time."
sourceUrl: "https://dallasmakerspace.org/wiki/Covid-19_reopening_rules"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Covid-19_reopening_rules\">legacy DMS wiki</a> — content may be outdated."
---
The following rules apply for the re-opening period following COVID-19. There is no set end-date for these rules at this time.
...
<img src="/dms-source/files/mw/c_c7_Unfiltered_exhaust_mask.jpg" width="568" height="424" alt="Disallowed mask type - unfiltered exhaust" />

- Sewn cloth masks
  - Paul has made a fantastic tutorial in case you want to make one: <https://youtu.be/wRnkX3iZNn8>
- Surgical masks
...
All classes must follow social distancing and mask guidelines.
