---
title: "Frankenstein Polaroid"
description: "Frankenstein Polaroid is a camera that will take Polaroid Packfilm Instant Film but have the fun and ease of use of modern 35mm cameras."
sourceUrl: "https://dallasmakerspace.org/wiki/Frankenstein_Polaroid"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Frankenstein_Polaroid\">legacy DMS wiki</a> — content may be outdated."
---
...
The 114mm lenses ( by far the most common focal length ) had maximum apertures ranging from F3.8 to F9.2. A replacement lens could really have any aperture or focal length within reason. The information we need is the image circle size. Unfortunately [this site](http://www.mamutphoto.com/content/view/141/43/lang,en/) says you can't find the image circle size without the angle of coverage. The angle of coverage varies between lenses.
...
It is all [here](http://www.rwhirled.com/landlist/landdcam-pack.htm).
...
Another thing to point out is that most of the Polaroid cameras have very "slow" lenses. The maximum aperture is usually something like F/8.8. Interior shots at night have a scene exposure value of about 5. If you use an [exposure table](http://www.fredparker.com/ultexp1.htm) you can see that even with the high ISO Fuji Film, which is about ISO 3000, you can't get a good shutter speed until you have an aperture of about F/4. A Frankenroid would be able to have lenses this fast if designed properly.

## Just get a conventional medium format camera with a polaroid back

[list of polaroid backs](http://www.keh.com/Search-Products/1/Brand/0/polaroid/Grade/0/0/SE.aspx) Possible cameras:

- Bronica ETRS
  - a complete setup costs between \$200 and \$400
  - [keh.com](http://www.keh.com/Search-Products/1/Brand/0/bronica%20etrs/Grade/0/0/SE.aspx)
- Bronica GS-1
  - camera outfit \$380 - \$800
  - [keh.com](http://www.keh.com/Search-Products/1/Brand/0/bronica%20gs-1/Grade/0/0/SE.aspx)
- Mamiya 645 (Pro, Super ) (?)
  - manual focus camera outfit \$250 - \$500
  - [keh.com](http://www.keh.com/Search-Products/1/Brand/0/mamiya%20645/Grade/0/0/SE.aspx) (that link might be bad)
...
The cheap way to get something along these lines is to get a shutter and lens combination from an old camera and build a box around a cut up junk-o non-folding Polaroid (like the [Colorpack III](http://www.rwhirled.com/landlist/landdcam-pack.htm#CPIII)).
...
- [using 35mm camera lenses on a medium format camera using a hacked teleconverter](http://members.tripod.com/rick_oleson/index-151.html)
- [35mm Polaroid, a.k.a. the "Minoltaroid Spirit"](http://photo.net/alternative-cameras-forum/00NbmU)
  - [\[1\]](http://www.flickr.com/photos/artistofmimicry/2090364298/)
  - [\[2\]](http://www.flickr.com/photos/artistofmimicry/2099824190/)
- [a basic online lens simulator](http://webphysics.davidson.edu/course_Material/Py230L/optics/lenses.htm) - if you have Firebug installed, you can edit the source of the page live to make the width larger, so as to be a more useful for larger setups

## about shutters

There are two main types:

- focal plain shutters [learn more here](http://www.penmachine.com/2008/09/camera-works-shutters-flashes-and-sync)
...
[amazing presentation on non-symmetric lenses](http://www.aspe.net/publications/Winter_2004/SLIDES/5KEYNOTE/ASPEp01.htm) (I should make a PDF of this in case it disappears. It documents part of the Polaroid company's engineering and is a real eye-popper. Those guys were amazing!)

[and here is the PDF for the presentation!](http://www.aspe.net/publications/Winter_2004/PAPERS/5KEYNOTE/1374.PDF)

[explanation of the SX-70](http://www.youtube.com/watch?v=5jaiq_ZZ_eM&feature=player_embedded)
...
So then I stumbled across [this Instructable](http://www.instructables.com/id/Modify-Your-Polaroid-Spectra-Camera-to-use-Non-Pol/) to use traditional cut film in a Spectra camera. Cut film is also called sheet film, and its just a big piece of film that you expose one at a time. You use a [cut film holder](http://www.calumetphoto.com/item/LS3400/?t=GB01&a=CA01&CAWELAID=36795254) to hold a single exposure, and slide each film holder into the camera one at a time to take the photo. There is a dark slide that you slide over the film to keep it light tight so you can switch to the next film holder. It is pretty zany stuff if you've never seen it.

Another idea is to convert a Polaroid camera to a pinhole camera and use it with [positive photo paper](http://www.ilfordphoto.com/products/product.asp?n=66&t=Photographic+Papers).
