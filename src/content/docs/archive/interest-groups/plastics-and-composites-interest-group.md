---
title: "Plastics and Composites Interest Group"
description: "The Plastics and Composites Special Interest Group is a group of DMS members who are interested in fabricating items from plastics and/or composites. In al..."
sourceUrl: "https://dallasmakerspace.org/wiki/Plastics_and_Composites_Interest_Group"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Plastics_and_Composites_Interest_Group\">legacy DMS wiki</a> — content may be outdated."
---
The Plastics and Composites Special Interest Group is a group of DMS members who are interested in fabricating items from plastics and/or composites. In all cases, the use of the word **Plastics** on this page generally refers to plastics and all related composites.
...
Jay Phelps - volunteered to work on [Shapeoko 3XXL](/dms-source/archive/machine-shop/shapeoko-3xxl/)

Angelica Johnson - TALK handle: angelica

## Tools and Supplies

### [Tools](/dms-source/archive/dallas-makerspace/tools/#Plastics_.26_Composites)

1.  [Shapeoko 3XXL **(Training Required)**](/dms-source/archive/machine-shop/shapeoko-3xxl/)
2.  [Formech Vacuum Former **(Training Required)**](/dms-source/archive/3d-fabrication/vacuum-former/)
3.  [Jet Band Saw **(Training Required)**](/dms-source/archive/uncategorized/jet-bandsaw/)
4.  [Porter Cable Router **(Training Required)**](/dms-source/archive/uncategorized/porter-cable-table-router/)
5.  [DeWalt Table Saw **(Training Required)**](/dms-source/archive/uncategorized/dewalt-table-saw/)
...
- Lasers are a valuable tool for cutting plastics and are available in the Laser area. It is important that proper venting be followed as some plastics generate noxious fumes. A prohibited example would be PVC which can generate Chlorine gas when heated. Consult the approved materials list in the Laser committee page and area. [\[1\]](/dms-source/archive/laser/laser-cutter-materials/)

## Rules and Safety

As a SIG under the governance of the Machine Shop Committee, the Plastics group will follow all of the rules as set forth in the Machine Shop [**rules**](/dms-source/archive/machine-shop/#Safety_and_Machine_Shop_Rules).
...
[Plastic Suppliers](/dms-source/archive/makery-stores/plastics-suppliers/)

### Tutorials and Reference Sites

- [Tap Plastic Co. YouTube Videos](https://www.youtube.com/user/tapplastics/videos): Vendor's videos include topics such as cutting, glueing, heat bending, casting, etc. Kinda geared at their products but the information is quite useful.
- [Vaccuum Former Page](/dms-source/archive/3d-fabrication/vacuum-former/)
