---
title: "Training Development SIG"
description: "The Training Development SIG is a collection of instructional designers (IDs), trainers, and teaching professionals who are interested in helping the DMS c..."
sourceUrl: "https://dallasmakerspace.org/wiki/Training_Development_SIG"
sidebar:
  hidden: true
banner:
  content: "Archived from the <a href=\"https://dallasmakerspace.org/wiki/Training_Development_SIG\">legacy DMS wiki</a> — content may be outdated."
---
## Purpose

The Training Development SIG is a collection of instructional designers (IDs), trainers, and teaching professionals who are interested in helping the DMS community create effective training. In Talk, our name is @Team_TrainDev.
...
- After the course is reviewed, it will be published in [Moodle](http://learn.dallasmakerspace.org/).
...
- [Category:Class curriculum](/dms-source/archive/class-curriculum/)
- Wiki page: [Classes](/dms-source/archive/dallas-makerspace/classes/)
- [Moodle](http://learn.dallasmakerspace.org/)

## Past Presentations

[DMS Basic Training Development Process](https://dallasmakerspace.org/w/images/b/b3/DMS_Basic_Training_Development_Process.pdf), presented 4-22-2017

[Training Development: How to Teach Adults at DMS](https://dallasmakerspace.org/w/images/1/11/TD-How_to_Teach_Adults_at_Makerspace.pdf), presented 8-26-2017



Keywords: training development, Team_TrainDev, instructional design, adult learning, course development
